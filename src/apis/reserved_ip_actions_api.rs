...
pub async fn reserved_ips_actions_get(
    configuration: &configuration::Configuration,
    reserved_ip: &str,
    action_id: i32,
) -> Result<models::ReservedIpsActionsPost201Response, Error<ReservedIpsActionsGetError>> {
...
pub async fn reserved_ips_actions_list(
    configuration: &configuration::Configuration,
    reserved_ip: &str,
) -> Result<models::ReservedIpsActionsList200Response, Error<ReservedIpsActionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ip = reserved_ip;
...
pub async fn reserved_ips_actions_post(
    configuration: &configuration::Configuration,
    reserved_ip: &str,
    reserved_ips_actions_post_request: Option<models::ReservedIpsActionsPostRequest>,
) -> Result<models::ReservedIpsActionsPost201Response, Error<ReservedIpsActionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ip = reserved_ip;
