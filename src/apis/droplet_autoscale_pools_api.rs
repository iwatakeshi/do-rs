...
pub async fn autoscalepools_create(
    configuration: &configuration::Configuration,
    autoscale_pool_create: Option<models::AutoscalePoolCreate>,
) -> Result<models::AutoscalepoolsCreate202Response, Error<AutoscalepoolsCreateError>> {
...
pub async fn autoscalepools_delete(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
) -> Result<(), Error<AutoscalepoolsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        autoscale_pool_id = crate::apis::urlencode(p_path_autoscale_pool_id)
    );
    let mut req_builder = configuration
        .client
...
pub async fn autoscalepools_delete_dangerous(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    x_dangerous: bool,
) -> Result<(), Error<AutoscalepoolsDeleteDangerousError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_autoscale_pool_id = autoscale_pool_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AutoscalepoolsDeleteDangerousError> =
...
pub async fn autoscalepools_get(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
) -> Result<models::AutoscalepoolsCreate202Response, Error<AutoscalepoolsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_autoscale_pool_id = autoscale_pool_id;
...
pub async fn autoscalepools_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
    name: Option<&str>,
) -> Result<models::AutoscalepoolsList200Response, Error<AutoscalepoolsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn autoscalepools_list_history(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::AutoscalepoolsListHistory200Response, Error<AutoscalepoolsListHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_autoscale_pool_id = autoscale_pool_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn autoscalepools_list_members(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::AutoscalepoolsListMembers200Response, Error<AutoscalepoolsListMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_autoscale_pool_id = autoscale_pool_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn autoscalepools_update(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    autoscale_pool_create: Option<models::AutoscalePoolCreate>,
) -> Result<models::AutoscalepoolsCreate202Response, Error<AutoscalepoolsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_autoscale_pool_id = autoscale_pool_id;
    let p_body_autoscale_pool_create = autoscale_pool_create;
