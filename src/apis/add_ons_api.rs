...
pub async fn addons_create(
    ...
    addons_resource_new: models::AddonsResourceNew,
) -> Result<models::AddonsCreate200Response, Error<AddonsCreateError>> {
...
pub async fn addons_delete(
    configuration: &configuration::Configuration,
    resource_uuid: &str,
) -> Result<(), Error<AddonsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        resource_uuid = crate::apis::urlencode(p_path_resource_uuid)
    );
    let mut req_builder = configuration
        .client
...
pub async fn addons_get(
    configuration: &configuration::Configuration,
    resource_uuid: &str,
) -> Result<models::AddonsCreate200Response, Error<AddonsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
...
pub async fn addons_get_app(
    configuration: &configuration::Configuration,
) -> Result<models::AddonsGetApp200Response, Error<AddonsGetAppError>> {
...
pub async fn addons_get_app_metadata(
    configuration: &configuration::Configuration,
    app_slug: &str,
) -> Result<models::AddonsGetAppMetadata200Response, Error<AddonsGetAppMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        app_slug = crate::apis::urlencode(p_path_app_slug)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn addons_list(
    configuration: &configuration::Configuration,
) -> Result<models::AddonsList200Response, Error<AddonsListError>> {
    let uri_str = format!("{}/v2/add-ons/saas", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn addons_patch(
    configuration: &configuration::Configuration,
    resource_uuid: &str,
    addons_patch_request: models::AddonsPatchRequest,
) -> Result<models::AddonsCreate200Response, Error<AddonsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
...
pub async fn addons_patch_plan(
    configuration: &configuration::Configuration,
    resource_uuid: &str,
    addons_patch_plan_request: models::AddonsPatchPlanRequest,
) -> Result<models::AddonsCreate200Response, Error<AddonsPatchPlanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
