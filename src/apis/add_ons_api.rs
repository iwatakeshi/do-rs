...
/// struct for typed errors of method [`addons_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsCreateError {
...
/// struct for typed errors of method [`addons_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsDeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`addons_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsGetError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`addons_get_app`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsGetAppError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
/// struct for typed errors of method [`addons_get_app_metadata`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsGetAppMetadataError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`addons_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsListError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
/// struct for typed errors of method [`addons_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsPatchError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`addons_patch_plan`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AddonsPatchPlanError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
pub async fn addons_create(configuration: &configuration::Configuration, addons_resource_new: models::AddonsResourceNew) -> Result<models::AddonsCreate200Response, Error<AddonsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_addons_resource_new = addons_resource_new;

    let uri_str = format!("{}/v2/add-ons/saas", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_addons_resource_new);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AddonsCreate200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AddonsCreate200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddonsCreateError> = serde_json::from_str(&content).ok();
...
pub async fn addons_delete(configuration: &configuration::Configuration, resource_uuid: &str) -> Result<(), Error<AddonsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;

    let uri_str = format!("{}/v2/add-ons/saas/{resource_uuid}", configuration.base_path, resource_uuid=crate::apis::urlencode(p_path_resource_uuid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddonsDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn addons_get(configuration: &configuration::Configuration, resource_uuid: &str) -> Result<models::AddonsCreate200Response, Error<AddonsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddonsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To fetch details of all available Add-On Applications, send a GET request to `/v2/add-ons/apps`. 
pub async fn addons_get_app(configuration: &configuration::Configuration, ) -> Result<models::AddonsGetApp200Response, Error<AddonsGetAppError>> {

    let uri_str = format!("{}/v2/add-ons/apps", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AddonsGetApp200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AddonsGetApp200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddonsGetAppError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn addons_get_app_metadata(configuration: &configuration::Configuration, app_slug: &str) -> Result<models::AddonsGetAppMetadata200Response, Error<AddonsGetAppMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_slug = app_slug;

    let uri_str = format!("{}/v2/add-ons/apps/{app_slug}/metadata", configuration.base_path, app_slug=crate::apis::urlencode(p_path_app_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AddonsGetAppMetadata200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AddonsGetAppMetadata200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddonsGetAppMetadataError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To fetch all Add-On Resources under your team, send a GET request to `/v2/add-ons/saas`. 
pub async fn addons_list(configuration: &configuration::Configuration, ) -> Result<models::AddonsList200Response, Error<AddonsListError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AddonsList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AddonsList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<AddonsListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn addons_patch(configuration: &configuration::Configuration, resource_uuid: &str, addons_patch_request: models::AddonsPatchRequest) -> Result<models::AddonsCreate200Response, Error<AddonsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
    let p_body_addons_patch_request = addons_patch_request;
    ...
    req_builder = req_builder.json(&p_body_addons_patch_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddonsPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn addons_patch_plan(configuration: &configuration::Configuration, resource_uuid: &str, addons_patch_plan_request: models::AddonsPatchPlanRequest) -> Result<models::AddonsCreate200Response, Error<AddonsPatchPlanError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_resource_uuid = resource_uuid;
    let p_body_addons_patch_plan_request = addons_patch_plan_request;

    let uri_str = format!("{}/v2/add-ons/saas/{resource_uuid}/plan", configuration.base_path, resource_uuid=crate::apis::urlencode(p_path_resource_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_addons_patch_plan_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddonsPatchPlanError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
