...
pub async fn firewalls_add_rules(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_add_rules_request: Option<models::FirewallsAddRulesRequest>,
) -> Result<(), Error<FirewallsAddRulesError>> {
    ...
    let uri_str = format!(
        ...
        firewall_id = crate::apis::urlencode(p_path_firewall_id)
    );
...
pub async fn firewalls_add_tags(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_add_tags_request: Option<models::FirewallsAddTagsRequest>,
) -> Result<(), Error<FirewallsAddTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_assign_droplets(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_assign_droplets_request: Option<models::FirewallsAssignDropletsRequest>,
) -> Result<(), Error<FirewallsAssignDropletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_create(
    configuration: &configuration::Configuration,
    firewalls_create_request: Option<models::FirewallsCreateRequest>,
) -> Result<models::FirewallsCreate202Response, Error<FirewallsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn firewalls_delete(
    configuration: &configuration::Configuration,
    firewall_id: &str,
) -> Result<(), Error<FirewallsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_delete_droplets(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_delete_droplets_request: Option<models::FirewallsDeleteDropletsRequest>,
) -> Result<(), Error<FirewallsDeleteDropletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_delete_rules(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_add_rules_request: Option<models::FirewallsAddRulesRequest>,
) -> Result<(), Error<FirewallsDeleteRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
    let p_body_firewalls_add_rules_request = firewalls_add_rules_request;
...
pub async fn firewalls_delete_tags(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_delete_tags_request: Option<models::FirewallsDeleteTagsRequest>,
) -> Result<(), Error<FirewallsDeleteTagsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_get(
    configuration: &configuration::Configuration,
    firewall_id: &str,
) -> Result<models::FirewallsCreate202Response, Error<FirewallsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
...
pub async fn firewalls_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListFirewalls200Response, Error<FirewallsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn firewalls_update(
    configuration: &configuration::Configuration,
    firewall_id: &str,
    firewalls_update_request: Option<models::FirewallsUpdateRequest>,
) -> Result<models::FirewallsCreate202Response, Error<FirewallsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_firewall_id = firewall_id;
