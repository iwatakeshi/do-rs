...
pub async fn load_balancers_add_droplets(
    configuration: &configuration::Configuration,
    lb_id: &str,
    load_balancers_add_droplets_request: models::LoadBalancersAddDropletsRequest,
) -> Result<(), Error<LoadBalancersAddDropletsError>> {
    ...
    let uri_str = format!(
        ...
        lb_id = crate::apis::urlencode(p_path_lb_id)
    );
...
pub async fn load_balancers_add_forwarding_rules(
    configuration: &configuration::Configuration,
    lb_id: &str,
    load_balancers_add_forwarding_rules_request: models::LoadBalancersAddForwardingRulesRequest,
) -> Result<(), Error<LoadBalancersAddForwardingRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_forwarding_rules_request =
        load_balancers_add_forwarding_rules_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersAddForwardingRulesError> =
...
pub async fn load_balancers_create(
    configuration: &configuration::Configuration,
    load_balancer_create: models::LoadBalancerCreate,
) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn load_balancers_delete(
    configuration: &configuration::Configuration,
    lb_id: &str,
) -> Result<(), Error<LoadBalancersDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
...
pub async fn load_balancers_delete_cache(
    configuration: &configuration::Configuration,
    lb_id: &str,
) -> Result<(), Error<LoadBalancersDeleteCacheError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
...
pub async fn load_balancers_get(
    configuration: &configuration::Configuration,
    lb_id: &str,
) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
...
pub async fn load_balancers_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::LoadBalancersList200Response, Error<LoadBalancersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn load_balancers_remove_droplets(
    configuration: &configuration::Configuration,
    lb_id: &str,
    load_balancers_add_droplets_request: models::LoadBalancersAddDropletsRequest,
) -> Result<(), Error<LoadBalancersRemoveDropletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_droplets_request = load_balancers_add_droplets_request;
...
pub async fn load_balancers_remove_forwarding_rules(
    configuration: &configuration::Configuration,
    lb_id: &str,
    load_balancers_add_forwarding_rules_request: models::LoadBalancersAddForwardingRulesRequest,
) -> Result<(), Error<LoadBalancersRemoveForwardingRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_forwarding_rules_request =
        load_balancers_add_forwarding_rules_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersRemoveForwardingRulesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn load_balancers_update(
    configuration: &configuration::Configuration,
    lb_id: &str,
    load_balancer_create: models::LoadBalancerCreate,
) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancer_create = load_balancer_create;
