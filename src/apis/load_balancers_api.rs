...
/// struct for typed errors of method [`load_balancers_delete_cache`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LoadBalancersDeleteCacheError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
pub async fn load_balancers_add_droplets(configuration: &configuration::Configuration, lb_id: &str, load_balancers_add_droplets_request: models::LoadBalancersAddDropletsRequest) -> Result<(), Error<LoadBalancersAddDropletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_droplets_request = load_balancers_add_droplets_request;

    let uri_str = format!("{}/v2/load_balancers/{lb_id}/droplets", configuration.base_path, lb_id=crate::apis::urlencode(p_path_lb_id));
    ...
    req_builder = req_builder.json(&p_body_load_balancers_add_droplets_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<LoadBalancersAddDropletsError> = serde_json::from_str(&content).ok();
...
pub async fn load_balancers_add_forwarding_rules(configuration: &configuration::Configuration, lb_id: &str, load_balancers_add_forwarding_rules_request: models::LoadBalancersAddForwardingRulesRequest) -> Result<(), Error<LoadBalancersAddForwardingRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_forwarding_rules_request = load_balancers_add_forwarding_rules_request;

    let uri_str = format!("{}/v2/load_balancers/{lb_id}/forwarding_rules", configuration.base_path, lb_id=crate::apis::urlencode(p_path_lb_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_load_balancers_add_forwarding_rules_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersAddForwardingRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_create(configuration: &configuration::Configuration, load_balancer_create: models::LoadBalancerCreate) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_load_balancer_create = load_balancer_create;

    let uri_str = format!("{}/v2/load_balancers", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_load_balancer_create);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LoadBalancersCreate202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LoadBalancersCreate202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<LoadBalancersCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_delete(configuration: &configuration::Configuration, lb_id: &str) -> Result<(), Error<LoadBalancersDeleteError>> {
    ...
    let uri_str = format!("{}/v2/load_balancers/{lb_id}", configuration.base_path, lb_id=crate::apis::urlencode(p_path_lb_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_delete_cache(configuration: &configuration::Configuration, lb_id: &str) -> Result<(), Error<LoadBalancersDeleteCacheError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;

    let uri_str = format!("{}/v2/load_balancers/{lb_id}/cache", configuration.base_path, lb_id=crate::apis::urlencode(p_path_lb_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersDeleteCacheError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To show information about a load balancer instance, send a GET request to `/v2/load_balancers/$LOAD_BALANCER_ID`. 
pub async fn load_balancers_get(configuration: &configuration::Configuration, lb_id: &str) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all of the load balancer instances on your account, send a GET request to `/v2/load_balancers`. 
pub async fn load_balancers_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>) -> Result<models::LoadBalancersList200Response, Error<LoadBalancersListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::LoadBalancersList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::LoadBalancersList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<LoadBalancersListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_remove_droplets(configuration: &configuration::Configuration, lb_id: &str, load_balancers_add_droplets_request: models::LoadBalancersAddDropletsRequest) -> Result<(), Error<LoadBalancersRemoveDropletsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_droplets_request = load_balancers_add_droplets_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersRemoveDropletsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_remove_forwarding_rules(configuration: &configuration::Configuration, lb_id: &str, load_balancers_add_forwarding_rules_request: models::LoadBalancersAddForwardingRulesRequest) -> Result<(), Error<LoadBalancersRemoveForwardingRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancers_add_forwarding_rules_request = load_balancers_add_forwarding_rules_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersRemoveForwardingRulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn load_balancers_update(configuration: &configuration::Configuration, lb_id: &str, load_balancer_create: models::LoadBalancerCreate) -> Result<models::LoadBalancersCreate202Response, Error<LoadBalancersUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_lb_id = lb_id;
    let p_body_load_balancer_create = load_balancer_create;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<LoadBalancersUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
