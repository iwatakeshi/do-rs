...
pub async fn registry_create(
    ...
    registry_create: models::RegistryCreate,
) -> Result<models::RegistryGet200Response, Error<RegistryCreateError>> {
...
pub async fn registry_delete(
    configuration: &configuration::Configuration,
) -> Result<(), Error<RegistryDeleteError>> {
    let uri_str = format!("{}/v2/registry", configuration.base_path);
    let mut req_builder = configuration
        .client
...
pub async fn registry_delete_repository_manifest(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    manifest_digest: &str,
) -> Result<(), Error<RegistryDeleteRepositoryManifestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistryDeleteRepositoryManifestError> =
...
pub async fn registry_delete_repository_tag(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    repository_tag: &str,
) -> Result<(), Error<RegistryDeleteRepositoryTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
...
pub async fn registry_get(
    configuration: &configuration::Configuration,
) -> Result<models::RegistryGet200Response, Error<RegistryGetError>> {
    let uri_str = format!("{}/v2/registry", configuration.base_path);
...
pub async fn registry_get_docker_credentials(
    configuration: &configuration::Configuration,
    expiry_seconds: Option<i32>,
    read_write: Option<bool>,
) -> Result<models::DockerCredentials, Error<RegistryGetDockerCredentialsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn registry_get_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistryGetGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
...
pub async fn registry_get_options(
    configuration: &configuration::Configuration,
) -> Result<models::RegistriesGetOptions200Response, Error<RegistryGetOptionsError>> {
...
pub async fn registry_get_subscription(
    configuration: &configuration::Configuration,
) -> Result<models::RegistriesGetSubscription200Response, Error<RegistryGetSubscriptionError>> {
...
pub async fn registry_list_garbage_collections(
    configuration: &configuration::Configuration,
    registry_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    Error<RegistryListGarbageCollectionsError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistryListGarbageCollectionsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registry_list_repositories(
    configuration: &configuration::Configuration,
    registry_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::RegistryListRepositories200Response, Error<RegistryListRepositoriesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn registry_list_repositories_v2(
    configuration: &configuration::Configuration,
    registry_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    page_token: Option<&str>,
) -> Result<models::RegistriesListRepositoriesV2200Response, Error<RegistryListRepositoriesV2Error>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_query_per_page = per_page;
...
pub async fn registry_list_repository_manifests(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    per_page: Option<i32>,
    ...
    Error<RegistryListRepositoryManifestsError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistryListRepositoryManifestsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registry_list_repository_tags(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::RegistriesListRepositoryTags200Response, Error<RegistryListRepositoryTagsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
...
pub async fn registry_run_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
    registry_run_gc: Option<models::RegistryRunGc>,
) -> Result<
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistryRunGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
...
pub async fn registry_update_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
    ...
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistryUpdateGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistryUpdateGarbageCollectionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registry_update_subscription(
    configuration: &configuration::Configuration,
    registries_update_subscription_request: Option<models::RegistriesUpdateSubscriptionRequest>,
) -> Result<models::RegistriesGetSubscription200Response, Error<RegistryUpdateSubscriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn registry_validate_name(
    configuration: &configuration::Configuration,
    validate_registry: models::ValidateRegistry,
) -> Result<(), Error<RegistryValidateNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
