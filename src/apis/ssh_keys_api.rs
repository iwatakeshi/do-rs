...
pub async fn ssh_keys_create(
    ...
    ssh_keys: models::SshKeys,
) -> Result<models::SshKeysCreate201Response, Error<SshKeysCreateError>> {
...
pub async fn ssh_keys_delete(
...
) -> Result<(), Error<SshKeysDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        ssh_key_identifier = p_path_ssh_key_identifier.to_string()
    );
    let mut req_builder = configuration
        .client
...
pub async fn ssh_keys_get(
    configuration: &configuration::Configuration,
    ssh_key_identifier: &str,
) -> Result<models::SshKeysCreate201Response, Error<SshKeysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_ssh_key_identifier = ssh_key_identifier;
...
pub async fn ssh_keys_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SshKeysList200Response, Error<SshKeysListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn ssh_keys_update(
    configuration: &configuration::Configuration,
    ssh_key_identifier: &str,
    ssh_keys_update_request: models::SshKeysUpdateRequest,
) -> Result<models::SshKeysCreate201Response, Error<SshKeysUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_ssh_key_identifier = ssh_key_identifier;
