...
pub async fn reserved_ips_create(
    configuration: &configuration::Configuration,
    reserved_ip_create: models::ReservedIpCreate,
) -> Result<models::ReservedIpsCreate202Response, Error<ReservedIpsCreateError>> {
...
pub async fn reserved_ips_delete(
    configuration: &configuration::Configuration,
    reserved_ip: &str,
) -> Result<(), Error<ReservedIpsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        reserved_ip = crate::apis::urlencode(p_path_reserved_ip)
    );
    let mut req_builder = configuration
        .client
...
pub async fn reserved_ips_get(
    configuration: &configuration::Configuration,
    reserved_ip: &str,
) -> Result<models::ReservedIpsGet200Response, Error<ReservedIpsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ip = reserved_ip;
...
pub async fn reserved_ips_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ReservedIpsList200Response, Error<ReservedIpsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
