...
pub async fn droplets_create(
    configuration: &configuration::Configuration,
    droplets_create_request: Option<models::DropletsCreateRequest>,
) -> Result<models::DropletsCreate202Response, Error<DropletsCreateError>> {
...
pub async fn droplets_destroy(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<(), Error<DropletsDestroyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn droplets_destroy_by_tag(
    configuration: &configuration::Configuration,
    tag_name: &str,
) -> Result<(), Error<DropletsDestroyByTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn droplets_destroy_retry_with_associated_resources(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<(), Error<DropletsDestroyRetryWithAssociatedResourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsDestroyRetryWithAssociatedResourcesError> =
...
pub async fn droplets_destroy_with_associated_resources_dangerous(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    x_dangerous: bool,
) -> Result<(), Error<DropletsDestroyWithAssociatedResourcesDangerousError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsDestroyWithAssociatedResourcesDangerousError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn droplets_destroy_with_associated_resources_selective(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    selective_destroy_associated_resource: Option<models::SelectiveDestroyAssociatedResource>,
) -> Result<(), Error<DropletsDestroyWithAssociatedResourcesSelectiveError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsDestroyWithAssociatedResourcesSelectiveError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn droplets_get(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<models::DropletsGet200Response, Error<DropletsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
...
pub async fn droplets_get_backup_policy(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<models::DropletsGetBackupPolicy200Response, Error<DropletsGetBackupPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
...
pub async fn droplets_get_destroy_associated_resources_status(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<models::AssociatedResourceStatus, Error<DropletsGetDestroyAssociatedResourcesStatusError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsGetDestroyAssociatedResourcesStatusError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn droplets_list(
    ...
    name: Option<&str>,
    r#type: Option<&str>,
) -> Result<models::DropletsList200Response, Error<DropletsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn droplets_list_associated_resources(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<
    models::DropletsListAssociatedResources200Response,
    Error<DropletsListAssociatedResourcesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsListAssociatedResourcesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn droplets_list_backup_policies(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListBackupPolicies200Response, Error<DropletsListBackupPoliciesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn droplets_list_backups(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListBackups200Response, Error<DropletsListBackupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn droplets_list_firewalls(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListFirewalls200Response, Error<DropletsListFirewallsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn droplets_list_kernels(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListKernels200Response, Error<DropletsListKernelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn droplets_list_neighbors(
    configuration: &configuration::Configuration,
    droplet_id: i32,
) -> Result<models::DropletsListNeighbors200Response, Error<DropletsListNeighborsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
...
pub async fn droplets_list_neighbors_ids(
    configuration: &configuration::Configuration,
) -> Result<models::NeighborIds, Error<DropletsListNeighborsIdsError>> {
    let uri_str = format!(
...
pub async fn droplets_list_snapshots(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DropletsListSnapshots200Response, Error<DropletsListSnapshotsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn droplets_list_supported_backup_policies(
    configuration: &configuration::Configuration,
) -> Result<
    models::DropletsListSupportedBackupPolicies200Response,
    Error<DropletsListSupportedBackupPoliciesError>,
> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DropletsListSupportedBackupPoliciesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
