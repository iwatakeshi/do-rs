...
pub async fn certificates_create(
    ...
    certificates_create_request: models::CertificatesCreateRequest,
) -> Result<models::CertificatesCreate201Response, Error<CertificatesCreateError>> {
...
pub async fn certificates_delete(
    configuration: &configuration::Configuration,
    certificate_id: &str,
) -> Result<(), Error<CertificatesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn certificates_get(
    configuration: &configuration::Configuration,
    certificate_id: &str,
) -> Result<models::CertificatesCreate201Response, Error<CertificatesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_certificate_id = certificate_id;
...
pub async fn certificates_list(
    ...
    page: Option<i32>,
    name: Option<&str>,
) -> Result<models::CertificatesList200Response, Error<CertificatesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
