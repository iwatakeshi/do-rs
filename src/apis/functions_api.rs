...
pub async fn functions_create_namespace(
    configuration: &configuration::Configuration,
    create_namespace: models::CreateNamespace,
) -> Result<models::FunctionsCreateNamespace200Response, Error<FunctionsCreateNamespaceError>> {
...
pub async fn functions_create_trigger(
    configuration: &configuration::Configuration,
    namespace_id: &str,
    create_trigger: models::CreateTrigger,
) -> Result<models::FunctionsCreateTrigger200Response, Error<FunctionsCreateTriggerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        namespace_id = crate::apis::urlencode(p_path_namespace_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
...
pub async fn functions_delete_namespace(
    configuration: &configuration::Configuration,
    namespace_id: &str,
) -> Result<(), Error<FunctionsDeleteNamespaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
...
pub async fn functions_delete_trigger(
    configuration: &configuration::Configuration,
    namespace_id: &str,
    trigger_name: &str,
) -> Result<(), Error<FunctionsDeleteTriggerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        namespace_id = crate::apis::urlencode(p_path_namespace_id),
        trigger_name = crate::apis::urlencode(p_path_trigger_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn functions_get_namespace(
    configuration: &configuration::Configuration,
    namespace_id: &str,
) -> Result<models::FunctionsCreateNamespace200Response, Error<FunctionsGetNamespaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
...
pub async fn functions_get_trigger(
    configuration: &configuration::Configuration,
    namespace_id: &str,
    trigger_name: &str,
) -> Result<models::FunctionsCreateTrigger200Response, Error<FunctionsGetTriggerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
    let p_path_trigger_name = trigger_name;
...
pub async fn functions_list_namespaces(
    configuration: &configuration::Configuration,
) -> Result<models::FunctionsListNamespaces200Response, Error<FunctionsListNamespacesError>> {
    let uri_str = format!("{}/v2/functions/namespaces", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn functions_list_triggers(
    configuration: &configuration::Configuration,
    namespace_id: &str,
) -> Result<models::FunctionsListTriggers200Response, Error<FunctionsListTriggersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
...
pub async fn functions_update_trigger(
    configuration: &configuration::Configuration,
    namespace_id: &str,
    trigger_name: &str,
    update_trigger: models::UpdateTrigger,
) -> Result<models::FunctionsCreateTrigger200Response, Error<FunctionsUpdateTriggerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_namespace_id = namespace_id;
    let p_path_trigger_name = trigger_name;
