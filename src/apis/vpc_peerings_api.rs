...
/// struct for typed errors of method [`vpc_peerings_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcPeeringsCreateError {
...
/// struct for typed errors of method [`vpc_peerings_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcPeeringsDeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`vpc_peerings_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcPeeringsGetError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`vpc_peerings_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcPeeringsListError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`vpc_peerings_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcPeeringsPatchError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
pub async fn vpc_peerings_create(configuration: &configuration::Configuration, vpc_peerings_create_request: models::VpcPeeringsCreateRequest) -> Result<models::VpcPeeringsCreate202Response, Error<VpcPeeringsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_vpc_peerings_create_request = vpc_peerings_create_request;

    let uri_str = format!("{}/v2/vpc_peerings", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_vpc_peerings_create_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcPeeringsCreate202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcPeeringsCreate202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcPeeringsCreateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To delete a VPC peering, send a DELETE request to `/v2/vpc_peerings/$VPC_PEERING_ID`. 
pub async fn vpc_peerings_delete(configuration: &configuration::Configuration, vpc_peering_id: &str) -> Result<models::VpcPeeringsDelete202Response, Error<VpcPeeringsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_peering_id = vpc_peering_id;

    let uri_str = format!("{}/v2/vpc_peerings/{vpc_peering_id}", configuration.base_path, vpc_peering_id=crate::apis::urlencode(p_path_vpc_peering_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcPeeringsDelete202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcPeeringsDelete202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcPeeringsDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To show information about an existing VPC Peering, send a GET request to `/v2/vpc_peerings/$VPC_PEERING_ID`. 
pub async fn vpc_peerings_get(configuration: &configuration::Configuration, vpc_peering_id: &str) -> Result<models::VpcPeeringsGet200Response, Error<VpcPeeringsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_peering_id = vpc_peering_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcPeeringsGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcPeeringsGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcPeeringsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all of the VPC peerings on your account, send a GET request to `/v2/vpc_peerings`.
pub async fn vpc_peerings_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>, region: Option<models::RegionSlug>) -> Result<models::VpcPeeringsList200Response, Error<VpcPeeringsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcPeeringsList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcPeeringsList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcPeeringsListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn vpc_peerings_patch(configuration: &configuration::Configuration, vpc_peering_id: &str, vpc_peering_updatable: models::VpcPeeringUpdatable) -> Result<models::VpcPeeringsGet200Response, Error<VpcPeeringsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_peering_id = vpc_peering_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VpcPeeringsPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
