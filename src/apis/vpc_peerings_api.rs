...
pub async fn vpc_peerings_create(
    configuration: &configuration::Configuration,
    vpc_peerings_create_request: models::VpcPeeringsCreateRequest,
) -> Result<models::VpcPeeringsCreate202Response, Error<VpcPeeringsCreateError>> {
...
pub async fn vpc_peerings_delete(
    configuration: &configuration::Configuration,
    vpc_peering_id: &str,
) -> Result<models::VpcPeeringsDelete202Response, Error<VpcPeeringsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn vpc_peerings_get(
    configuration: &configuration::Configuration,
    vpc_peering_id: &str,
) -> Result<models::VpcPeeringsGet200Response, Error<VpcPeeringsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_peering_id = vpc_peering_id;
...
pub async fn vpc_peerings_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
    region: Option<models::RegionSlug>,
) -> Result<models::VpcPeeringsList200Response, Error<VpcPeeringsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn vpc_peerings_patch(
    configuration: &configuration::Configuration,
    vpc_peering_id: &str,
    vpc_peering_updatable: models::VpcPeeringUpdatable,
) -> Result<models::VpcPeeringsGet200Response, Error<VpcPeeringsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_peering_id = vpc_peering_id;
