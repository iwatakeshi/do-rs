...
pub async fn genai_attach_agent(configuration: &configuration::Configuration, parent_agent_uuid: &str, child_agent_uuid: &str, api_link_agent_input_public: Option<models::ApiLinkAgentInputPublic>) -> Result<models::ApiLinkAgentOutput, Error<GenaiAttachAgentError>> {
    ...
    let uri_str = format!("{}/v2/gen-ai/agents/{parent_agent_uuid}/child_agents/{child_agent_uuid}", configuration.base_path, parent_agent_uuid=crate::apis::urlencode(p_path_parent_agent_uuid), child_agent_uuid=crate::apis::urlencode(p_path_child_agent_uuid));
...
pub async fn genai_attach_agent_function(configuration: &configuration::Configuration, agent_uuid: &str, api_link_agent_function_input_public: Option<models::ApiLinkAgentFunctionInputPublic>) -> Result<models::ApiLinkAgentFunctionOutput, Error<GenaiAttachAgentFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_body_api_link_agent_function_input_public = api_link_agent_function_input_public;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/functions", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn genai_attach_knowledge_base(configuration: &configuration::Configuration, agent_uuid: &str, knowledge_base_uuid: &str) -> Result<models::ApiLinkKnowledgeBaseOutput, Error<GenaiAttachKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_knowledge_base_uuid = knowledge_base_uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/knowledge_bases/{knowledge_base_uuid}", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid), knowledge_base_uuid=crate::apis::urlencode(p_path_knowledge_base_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn genai_attach_knowledge_bases(configuration: &configuration::Configuration, agent_uuid: &str) -> Result<models::ApiLinkKnowledgeBaseOutput, Error<GenaiAttachKnowledgeBasesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/knowledge_bases", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn genai_cancel_indexing_job(configuration: &configuration::Configuration, uuid: &str, api_cancel_knowledge_base_indexing_job_input_public: Option<models::ApiCancelKnowledgeBaseIndexingJobInputPublic>) -> Result<models::ApiCancelKnowledgeBaseIndexingJobOutput, Error<GenaiCancelIndexingJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_api_cancel_knowledge_base_indexing_job_input_public = api_cancel_knowledge_base_indexing_job_input_public;

    let uri_str = format!("{}/v2/gen-ai/indexing_jobs/{uuid}/cancel", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
...
pub async fn genai_create_agent(configuration: &configuration::Configuration, api_create_agent_input_public: Option<models::ApiCreateAgentInputPublic>) -> Result<models::ApiCreateAgentOutput, Error<GenaiCreateAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_create_agent_api_key(configuration: &configuration::Configuration, agent_uuid: &str, api_create_agent_api_key_input_public: Option<models::ApiCreateAgentApiKeyInputPublic>) -> Result<models::ApiCreateAgentApiKeyOutput, Error<GenaiCreateAgentApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_body_api_create_agent_api_key_input_public = api_create_agent_api_key_input_public;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/api_keys", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn genai_create_anthropic_api_key(configuration: &configuration::Configuration, api_create_anthropic_api_key_input_public: Option<models::ApiCreateAnthropicApiKeyInputPublic>) -> Result<models::ApiCreateAnthropicApiKeyOutput, Error<GenaiCreateAnthropicApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_anthropic_api_key_input_public = api_create_anthropic_api_key_input_public;
...
pub async fn genai_create_data_source_file_upload_presigned_urls(configuration: &configuration::Configuration, api_create_data_source_file_upload_presigned_urls_input_public: Option<models::ApiCreateDataSourceFileUploadPresignedUrlsInputPublic>) -> Result<models::ApiCreateDataSourceFileUploadPresignedUrlsOutput, Error<GenaiCreateDataSourceFileUploadPresignedUrlsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_data_source_file_upload_presigned_urls_input_public = api_create_data_source_file_upload_presigned_urls_input_public;

    let uri_str = format!("{}/v2/gen-ai/knowledge_bases/data_sources/file_upload_presigned_urls", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_api_create_data_source_file_upload_presigned_urls_input_public);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiCreateDataSourceFileUploadPresignedUrlsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To create an evaluation dataset, send a POST request to `/v2/gen-ai/evaluation_datasets`.
pub async fn genai_create_evaluation_dataset(configuration: &configuration::Configuration, api_create_evaluation_dataset_input_public: Option<models::ApiCreateEvaluationDatasetInputPublic>) -> Result<models::ApiCreateEvaluationDatasetOutput, Error<GenaiCreateEvaluationDatasetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_evaluation_dataset_input_public = api_create_evaluation_dataset_input_public;
...
pub async fn genai_create_evaluation_dataset_file_upload_presigned_urls(configuration: &configuration::Configuration, api_create_data_source_file_upload_presigned_urls_input_public: Option<models::ApiCreateDataSourceFileUploadPresignedUrlsInputPublic>) -> Result<models::ApiCreateDataSourceFileUploadPresignedUrlsOutput, Error<GenaiCreateEvaluationDatasetFileUploadPresignedUrlsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_data_source_file_upload_presigned_urls_input_public = api_create_data_source_file_upload_presigned_urls_input_public;

    let uri_str = format!("{}/v2/gen-ai/evaluation_datasets/file_upload_presigned_urls", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiCreateEvaluationDatasetFileUploadPresignedUrlsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To create an evaluation test-case send a POST request to `/v2/gen-ai/evaluation_test_cases`.
pub async fn genai_create_evaluation_test_case(configuration: &configuration::Configuration, api_create_evaluation_test_case_input_public: Option<models::ApiCreateEvaluationTestCaseInputPublic>) -> Result<models::ApiCreateEvaluationTestCaseOutput, Error<GenaiCreateEvaluationTestCaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_evaluation_test_case_input_public = api_create_evaluation_test_case_input_public;

    let uri_str = format!("{}/v2/gen-ai/evaluation_test_cases", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiCreateEvaluationTestCaseError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To start an indexing job for a knowledge base, send a POST request to `/v2/gen-ai/indexing_jobs`.
pub async fn genai_create_indexing_job(configuration: &configuration::Configuration, api_start_knowledge_base_indexing_job_input_public: Option<models::ApiStartKnowledgeBaseIndexingJobInputPublic>) -> Result<models::ApiStartKnowledgeBaseIndexingJobOutput, Error<GenaiCreateIndexingJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_start_knowledge_base_indexing_job_input_public = api_start_knowledge_base_indexing_job_input_public;
...
pub async fn genai_create_knowledge_base(configuration: &configuration::Configuration, api_create_knowledge_base_input_public: Option<models::ApiCreateKnowledgeBaseInputPublic>) -> Result<models::ApiCreateKnowledgeBaseOutput, Error<GenaiCreateKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_create_knowledge_base_data_source(configuration: &configuration::Configuration, knowledge_base_uuid: &str, api_create_knowledge_base_data_source_input_public: Option<models::ApiCreateKnowledgeBaseDataSourceInputPublic>) -> Result<models::ApiCreateKnowledgeBaseDataSourceOutput, Error<GenaiCreateKnowledgeBaseDataSourceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_knowledge_base_uuid = knowledge_base_uuid;
    let p_body_api_create_knowledge_base_data_source_input_public = api_create_knowledge_base_data_source_input_public;

    let uri_str = format!("{}/v2/gen-ai/knowledge_bases/{knowledge_base_uuid}/data_sources", configuration.base_path, knowledge_base_uuid=crate::apis::urlencode(p_path_knowledge_base_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiCreateKnowledgeBaseDataSourceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To create a model API key, send a POST request to `/v2/gen-ai/models/api_keys`.
pub async fn genai_create_model_api_key(configuration: &configuration::Configuration, api_create_model_api_key_input_public: Option<models::ApiCreateModelApiKeyInputPublic>) -> Result<models::ApiCreateModelApiKeyOutput, Error<GenaiCreateModelApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_create_oauth2_dropbox_tokens(configuration: &configuration::Configuration, api_dropbox_oauth2_get_tokens_input: Option<models::ApiDropboxOauth2GetTokensInput>) -> Result<models::ApiDropboxOauth2GetTokensOutput, Error<GenaiCreateOauth2DropboxTokensError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_dropbox_oauth2_get_tokens_input = api_dropbox_oauth2_get_tokens_input;

    let uri_str = format!("{}/v2/gen-ai/oauth2/dropbox/tokens", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiCreateOauth2DropboxTokensError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To create an OpenAI API key, send a POST request to `/v2/gen-ai/openai/keys`.
pub async fn genai_create_openai_api_key(configuration: &configuration::Configuration, api_create_open_aiapi_key_input_public: Option<models::ApiCreateOpenAiapiKeyInputPublic>) -> Result<models::ApiCreateOpenAiapiKeyOutput, Error<GenaiCreateOpenaiApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_create_scheduled_indexing(configuration: &configuration::Configuration, api_create_scheduled_indexing_input_public: Option<models::ApiCreateScheduledIndexingInputPublic>) -> Result<models::ApiCreateScheduledIndexingOutput, Error<GenaiCreateScheduledIndexingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_create_scheduled_indexing_input_public = api_create_scheduled_indexing_input_public;
...
pub async fn genai_create_workspace(configuration: &configuration::Configuration, api_create_workspace_input_public: Option<models::ApiCreateWorkspaceInputPublic>) -> Result<models::ApiCreateWorkspaceOutput, Error<GenaiCreateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_delete_agent(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiDeleteAgentOutput, Error<GenaiDeleteAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{uuid}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
...
pub async fn genai_delete_agent_api_key(configuration: &configuration::Configuration, agent_uuid: &str, api_key_uuid: &str) -> Result<models::ApiDeleteAgentApiKeyOutput, Error<GenaiDeleteAgentApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/api_keys/{api_key_uuid}", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid), api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_anthropic_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiDeleteAnthropicApiKeyOutput, Error<GenaiDeleteAnthropicApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/anthropic/keys/{api_key_uuid}", configuration.base_path, api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_knowledge_base(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiDeleteKnowledgeBaseOutput, Error<GenaiDeleteKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/v2/gen-ai/knowledge_bases/{uuid}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_knowledge_base_data_source(configuration: &configuration::Configuration, knowledge_base_uuid: &str, data_source_uuid: &str) -> Result<models::ApiDeleteKnowledgeBaseDataSourceOutput, Error<GenaiDeleteKnowledgeBaseDataSourceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_knowledge_base_uuid = knowledge_base_uuid;
    let p_path_data_source_uuid = data_source_uuid;

    let uri_str = format!("{}/v2/gen-ai/knowledge_bases/{knowledge_base_uuid}/data_sources/{data_source_uuid}", configuration.base_path, knowledge_base_uuid=crate::apis::urlencode(p_path_knowledge_base_uuid), data_source_uuid=crate::apis::urlencode(p_path_data_source_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiDeleteKnowledgeBaseDataSourceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To delete an API key for a model, send a DELETE request to `/v2/gen-ai/models/api_keys/{api_key_uuid}`.
pub async fn genai_delete_model_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiDeleteModelApiKeyOutput, Error<GenaiDeleteModelApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/models/api_keys/{api_key_uuid}", configuration.base_path, api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_openai_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiDeleteOpenAiapiKeyOutput, Error<GenaiDeleteOpenaiApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/openai/keys/{api_key_uuid}", configuration.base_path, api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_scheduled_indexing(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiDeleteScheduledIndexingOutput, Error<GenaiDeleteScheduledIndexingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/v2/gen-ai/scheduled-indexing/{uuid}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_delete_workspace(configuration: &configuration::Configuration, workspace_uuid: &str) -> Result<models::ApiDeleteWorkspaceOutput, Error<GenaiDeleteWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;

    let uri_str = format!("{}/v2/gen-ai/workspaces/{workspace_uuid}", configuration.base_path, workspace_uuid=crate::apis::urlencode(p_path_workspace_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_detach_agent(configuration: &configuration::Configuration, parent_agent_uuid: &str, child_agent_uuid: &str) -> Result<models::ApiUnlinkAgentOutput, Error<GenaiDetachAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_parent_agent_uuid = parent_agent_uuid;
    let p_path_child_agent_uuid = child_agent_uuid;
...
pub async fn genai_detach_agent_function(configuration: &configuration::Configuration, agent_uuid: &str, function_uuid: &str) -> Result<models::ApiUnlinkAgentFunctionOutput, Error<GenaiDetachAgentFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_function_uuid = function_uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/functions/{function_uuid}", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid), function_uuid=crate::apis::urlencode(p_path_function_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn genai_detach_knowledge_base(configuration: &configuration::Configuration, agent_uuid: &str, knowledge_base_uuid: &str) -> Result<models::ApiUnlinkKnowledgeBaseOutput, Error<GenaiDetachKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_knowledge_base_uuid = knowledge_base_uuid;
...
pub async fn genai_get_agent(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiGetAgentOutput, Error<GenaiGetAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn genai_get_agent_children(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiGetChildrenOutput, Error<GenaiGetAgentChildrenError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{uuid}/child_agents", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_agent_usage(configuration: &configuration::Configuration, uuid: &str, start: Option<&str>, stop: Option<&str>) -> Result<models::ApiGetAgentUsageOutput, Error<GenaiGetAgentUsageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_query_start = start;
    let p_query_stop = stop;

    let uri_str = format!("{}/v2/gen-ai/agents/{uuid}/usage", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_anthropic_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiGetAnthropicApiKeyOutput, Error<GenaiGetAnthropicApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;
...
pub async fn genai_get_evaluation_run(configuration: &configuration::Configuration, evaluation_run_uuid: &str) -> Result<models::ApiGetEvaluationRunOutput, Error<GenaiGetEvaluationRunError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_evaluation_run_uuid = evaluation_run_uuid;

    let uri_str = format!("{}/v2/gen-ai/evaluation_runs/{evaluation_run_uuid}", configuration.base_path, evaluation_run_uuid=crate::apis::urlencode(p_path_evaluation_run_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_evaluation_run_prompt_results(configuration: &configuration::Configuration, evaluation_run_uuid: &str, prompt_id: i32) -> Result<models::ApiGetEvaluationRunPromptResultsOutput, Error<GenaiGetEvaluationRunPromptResultsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_evaluation_run_uuid = evaluation_run_uuid;
    let p_path_prompt_id = prompt_id;

    let uri_str = format!("{}/v2/gen-ai/evaluation_runs/{evaluation_run_uuid}/results/{prompt_id}", configuration.base_path, evaluation_run_uuid=crate::apis::urlencode(p_path_evaluation_run_uuid), prompt_id=p_path_prompt_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiGetEvaluationRunPromptResultsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve results of an evaluation run, send a GET request to `/v2/gen-ai/evaluation_runs/{evaluation_run_uuid}/results`.
pub async fn genai_get_evaluation_run_results(configuration: &configuration::Configuration, evaluation_run_uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiGetEvaluationRunResultsOutput, Error<GenaiGetEvaluationRunResultsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_evaluation_run_uuid = evaluation_run_uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;

    let uri_str = format!("{}/v2/gen-ai/evaluation_runs/{evaluation_run_uuid}/results", configuration.base_path, evaluation_run_uuid=crate::apis::urlencode(p_path_evaluation_run_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_evaluation_test_case(configuration: &configuration::Configuration, test_case_uuid: &str, evaluation_test_case_version: Option<i32>) -> Result<models::ApiGetEvaluationTestCaseOutput, Error<GenaiGetEvaluationTestCaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_test_case_uuid = test_case_uuid;
    let p_query_evaluation_test_case_version = evaluation_test_case_version;

    let uri_str = format!("{}/v2/gen-ai/evaluation_test_cases/{test_case_uuid}", configuration.base_path, test_case_uuid=crate::apis::urlencode(p_path_test_case_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_evaluation_test_case_version {
        req_builder = req_builder.query(&[("evaluation_test_case_version", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
...
pub async fn genai_get_indexing_job(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiGetKnowledgeBaseIndexingJobOutput, Error<GenaiGetIndexingJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;

    let uri_str = format!("{}/v2/gen-ai/indexing_jobs/{uuid}", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_indexing_job_details_signed_url(configuration: &configuration::Configuration, indexing_job_uuid: &str) -> Result<models::ApiGetIndexingJobDetailsSignedUrlOutput, Error<GenaiGetIndexingJobDetailsSignedUrlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_indexing_job_uuid = indexing_job_uuid;

    let uri_str = format!("{}/v2/gen-ai/indexing_jobs/{indexing_job_uuid}/details_signed_url", configuration.base_path, indexing_job_uuid=crate::apis::urlencode(p_path_indexing_job_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiGetIndexingJobDetailsSignedUrlError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrive information about an existing knowledge base, send a GET request to `/v2/gen-ai/knowledge_bases/{uuid}`.
pub async fn genai_get_knowledge_base(configuration: &configuration::Configuration, uuid: &str) -> Result<models::ApiGetKnowledgeBaseOutput, Error<GenaiGetKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn genai_get_oauth2_url(configuration: &configuration::Configuration, r#type: Option<&str>, redirect_url: Option<&str>) -> Result<models::ApiGenerateOauth2UrlOutput, Error<GenaiGetOauth2UrlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_get_openai_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiGetOpenAiapiKeyOutput, Error<GenaiGetOpenaiApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;
...
pub async fn genai_get_scheduled_indexing(configuration: &configuration::Configuration, knowledge_base_uuid: &str) -> Result<models::ApiGetScheduledIndexingOutput, Error<GenaiGetScheduledIndexingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_knowledge_base_uuid = knowledge_base_uuid;

    let uri_str = format!("{}/v2/gen-ai/scheduled-indexing/knowledge-base/{knowledge_base_uuid}", configuration.base_path, knowledge_base_uuid=crate::apis::urlencode(p_path_knowledge_base_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_get_workspace(configuration: &configuration::Configuration, workspace_uuid: &str) -> Result<models::ApiGetWorkspaceOutput, Error<GenaiGetWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;
...
pub async fn genai_list_agent_api_keys(configuration: &configuration::Configuration, agent_uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentApiKeysOutput, Error<GenaiListAgentApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_agent_versions(configuration: &configuration::Configuration, uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentVersionsOutput, Error<GenaiListAgentVersionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;

    let uri_str = format!("{}/v2/gen-ai/agents/{uuid}/versions", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_list_agents(configuration: &configuration::Configuration, only_deployed: Option<bool>, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentsOutputPublic, Error<GenaiListAgentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_list_agents_by_anthropic_key(configuration: &configuration::Configuration, uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentsByAnthropicKeyOutput, Error<GenaiListAgentsByAnthropicKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;

    let uri_str = format!("{}/v2/gen-ai/anthropic/keys/{uuid}/agents", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListAgentsByAnthropicKeyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// List Agents by OpenAI Key.
pub async fn genai_list_agents_by_openai_key(configuration: &configuration::Configuration, uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentsByOpenAiKeyOutput, Error<GenaiListAgentsByOpenaiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;

    let uri_str = format!("{}/v2/gen-ai/openai/keys/{uuid}/agents", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_list_agents_by_workspace(configuration: &configuration::Configuration, workspace_uuid: &str, only_deployed: Option<bool>, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAgentsByWorkspaceOutput, Error<GenaiListAgentsByWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;
    let p_query_only_deployed = only_deployed;
    let p_query_page = page;
    ...
    let uri_str = format!("{}/v2/gen-ai/workspaces/{workspace_uuid}/agents", configuration.base_path, workspace_uuid=crate::apis::urlencode(p_path_workspace_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn genai_list_anthropic_api_keys(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListAnthropicApiKeysOutput, Error<GenaiListAnthropicApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_datacenter_regions(configuration: &configuration::Configuration, serves_inference: Option<bool>, serves_batch: Option<bool>) -> Result<models::ApiListRegionsOutput, Error<GenaiListDatacenterRegionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn genai_list_evaluation_metrics(configuration: &configuration::Configuration, ) -> Result<models::ApiListEvaluationMetricsOutput, Error<GenaiListEvaluationMetricsError>> {
...
pub async fn genai_list_evaluation_runs_by_test_case(configuration: &configuration::Configuration, evaluation_test_case_uuid: &str, evaluation_test_case_version: Option<i32>) -> Result<models::ApiListEvaluationRunsByTestCaseOutput, Error<GenaiListEvaluationRunsByTestCaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_evaluation_test_case_uuid = evaluation_test_case_uuid;
    let p_query_evaluation_test_case_version = evaluation_test_case_version;

    let uri_str = format!("{}/v2/gen-ai/evaluation_test_cases/{evaluation_test_case_uuid}/evaluation_runs", configuration.base_path, evaluation_test_case_uuid=crate::apis::urlencode(p_path_evaluation_test_case_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListEvaluationRunsByTestCaseError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all evaluation test cases, send a GET request to `/v2/gen-ai/evaluation_test_cases`.
pub async fn genai_list_evaluation_test_cases(configuration: &configuration::Configuration, ) -> Result<models::ApiListEvaluationTestCasesOutput, Error<GenaiListEvaluationTestCasesError>> {
...
pub async fn genai_list_evaluation_test_cases_by_workspace(configuration: &configuration::Configuration, workspace_uuid: &str) -> Result<models::ApiListEvaluationTestCasesByWorkspaceOutput, Error<GenaiListEvaluationTestCasesByWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;

    let uri_str = format!("{}/v2/gen-ai/workspaces/{workspace_uuid}/evaluation_test_cases", configuration.base_path, workspace_uuid=crate::apis::urlencode(p_path_workspace_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListEvaluationTestCasesByWorkspaceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all datasources for an indexing job, send a GET request to `/v2/gen-ai/indexing_jobs/{indexing_job_uuid}/data_sources`.
pub async fn genai_list_indexing_job_data_sources(configuration: &configuration::Configuration, indexing_job_uuid: &str) -> Result<models::ApiListIndexingJobDataSourcesOutput, Error<GenaiListIndexingJobDataSourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_indexing_job_uuid = indexing_job_uuid;

    let uri_str = format!("{}/v2/gen-ai/indexing_jobs/{indexing_job_uuid}/data_sources", configuration.base_path, indexing_job_uuid=crate::apis::urlencode(p_path_indexing_job_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListIndexingJobDataSourcesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all indexing jobs for a knowledge base, send a GET request to `/v2/gen-ai/indexing_jobs`.
pub async fn genai_list_indexing_jobs(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListKnowledgeBaseIndexingJobsOutput, Error<GenaiListIndexingJobsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_indexing_jobs_by_knowledge_base(configuration: &configuration::Configuration, knowledge_base_uuid: &str) -> Result<models::ApiListKnowledgeBaseIndexingJobsOutput, Error<GenaiListIndexingJobsByKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_knowledge_base_uuid = knowledge_base_uuid;

    let uri_str = format!("{}/v2/gen-ai/knowledge_bases/{knowledge_base_uuid}/indexing_jobs", configuration.base_path, knowledge_base_uuid=crate::apis::urlencode(p_path_knowledge_base_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListIndexingJobsByKnowledgeBaseError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn genai_list_knowledge_base_data_sources(configuration: &configuration::Configuration, knowledge_base_uuid: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListKnowledgeBaseDataSourcesOutput, Error<GenaiListKnowledgeBaseDataSourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_knowledge_base_uuid = knowledge_base_uuid;
    let p_query_page = page;
    let p_query_per_page = per_page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiListKnowledgeBaseDataSourcesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all knowledge bases, send a GET request to `/v2/gen-ai/knowledge_bases`.
pub async fn genai_list_knowledge_bases(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListKnowledgeBasesOutput, Error<GenaiListKnowledgeBasesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_model_api_keys(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListModelApiKeysOutput, Error<GenaiListModelApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_models(configuration: &configuration::Configuration, usecases: Option<Vec<String>>, public_only: Option<bool>, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListModelsOutputPublic, Error<GenaiListModelsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if let Some(ref param_value) = p_query_usecases {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("usecases".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("usecases", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn genai_list_openai_api_keys(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<models::ApiListOpenAiapiKeysOutput, Error<GenaiListOpenaiApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page = page;
    let p_query_per_page = per_page;
...
pub async fn genai_list_workspaces(configuration: &configuration::Configuration, ) -> Result<models::ApiListWorkspacesOutput, Error<GenaiListWorkspacesError>> {
...
pub async fn genai_regenerate_agent_api_key(configuration: &configuration::Configuration, agent_uuid: &str, api_key_uuid: &str) -> Result<models::ApiRegenerateAgentApiKeyOutput, Error<GenaiRegenerateAgentApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/agents/{agent_uuid}/api_keys/{api_key_uuid}/regenerate", configuration.base_path, agent_uuid=crate::apis::urlencode(p_path_agent_uuid), api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn genai_regenerate_model_api_key(configuration: &configuration::Configuration, api_key_uuid: &str) -> Result<models::ApiRegenerateModelApiKeyOutput, Error<GenaiRegenerateModelApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;

    let uri_str = format!("{}/v2/gen-ai/models/api_keys/{api_key_uuid}/regenerate", configuration.base_path, api_key_uuid=crate::apis::urlencode(p_path_api_key_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn genai_rollback_to_agent_version(configuration: &configuration::Configuration, uuid: &str, api_rollback_to_agent_version_input_public: Option<models::ApiRollbackToAgentVersionInputPublic>) -> Result<models::ApiRollbackToAgentVersionOutput, Error<GenaiRollbackToAgentVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_api_rollback_to_agent_version_input_public = api_rollback_to_agent_version_input_public;
...
pub async fn genai_run_evaluation_test_case(configuration: &configuration::Configuration, api_run_evaluation_test_case_input_public: Option<models::ApiRunEvaluationTestCaseInputPublic>) -> Result<models::ApiRunEvaluationTestCaseOutput, Error<GenaiRunEvaluationTestCaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_api_run_evaluation_test_case_input_public = api_run_evaluation_test_case_input_public;
...
pub async fn genai_update_agent(configuration: &configuration::Configuration, uuid: &str, api_update_agent_input_public: Option<models::ApiUpdateAgentInputPublic>) -> Result<models::ApiUpdateAgentOutput, Error<GenaiUpdateAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn genai_update_agent_api_key(configuration: &configuration::Configuration, agent_uuid: &str, api_key_uuid: &str, api_update_agent_api_key_input_public: Option<models::ApiUpdateAgentApiKeyInputPublic>) -> Result<models::ApiUpdateAgentApiKeyOutput, Error<GenaiUpdateAgentApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_api_key_uuid = api_key_uuid;
...
pub async fn genai_update_agent_deployment_visibility(configuration: &configuration::Configuration, uuid: &str, api_update_agent_deployment_visibility_input_public: Option<models::ApiUpdateAgentDeploymentVisibilityInputPublic>) -> Result<models::ApiUpdateAgentDeploymentVisbilityOutput, Error<GenaiUpdateAgentDeploymentVisibilityError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
    let p_body_api_update_agent_deployment_visibility_input_public = api_update_agent_deployment_visibility_input_public;

    let uri_str = format!("{}/v2/gen-ai/agents/{uuid}/deployment_visibility", configuration.base_path, uuid=crate::apis::urlencode(p_path_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiUpdateAgentDeploymentVisibilityError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To update the function route, send a PUT request to `/v2/gen-ai/agents/{agent_uuid}/functions/{function_uuid}`.
pub async fn genai_update_agent_function(configuration: &configuration::Configuration, agent_uuid: &str, function_uuid: &str, api_update_agent_function_input_public: Option<models::ApiUpdateAgentFunctionInputPublic>) -> Result<models::ApiUpdateAgentFunctionOutput, Error<GenaiUpdateAgentFunctionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_agent_uuid = agent_uuid;
    let p_path_function_uuid = function_uuid;
...
pub async fn genai_update_agents_workspace(configuration: &configuration::Configuration, workspace_uuid: &str, api_move_agents_to_workspace_input_public: Option<models::ApiMoveAgentsToWorkspaceInputPublic>) -> Result<models::ApiMoveAgentsToWorkspaceOutput, Error<GenaiUpdateAgentsWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;
    let p_body_api_move_agents_to_workspace_input_public = api_move_agents_to_workspace_input_public;
...
pub async fn genai_update_anthropic_api_key(configuration: &configuration::Configuration, api_key_uuid: &str, api_update_anthropic_api_key_input_public: Option<models::ApiUpdateAnthropicApiKeyInputPublic>) -> Result<models::ApiUpdateAnthropicApiKeyOutput, Error<GenaiUpdateAnthropicApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;
    let p_body_api_update_anthropic_api_key_input_public = api_update_anthropic_api_key_input_public;
...
pub async fn genai_update_attached_agent(configuration: &configuration::Configuration, parent_agent_uuid: &str, child_agent_uuid: &str, api_update_linked_agent_input_public: Option<models::ApiUpdateLinkedAgentInputPublic>) -> Result<models::ApiUpdateLinkedAgentOutput, Error<GenaiUpdateAttachedAgentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_parent_agent_uuid = parent_agent_uuid;
    let p_path_child_agent_uuid = child_agent_uuid;
...
pub async fn genai_update_evaluation_test_case(configuration: &configuration::Configuration, test_case_uuid: &str, api_update_evaluation_test_case_input_public: Option<models::ApiUpdateEvaluationTestCaseInputPublic>) -> Result<models::ApiUpdateEvaluationTestCaseOutput, Error<GenaiUpdateEvaluationTestCaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_test_case_uuid = test_case_uuid;
    let p_body_api_update_evaluation_test_case_input_public = api_update_evaluation_test_case_input_public;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GenaiUpdateEvaluationTestCaseError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To update a knowledge base, send a PUT request to `/v2/gen-ai/knowledge_bases/{uuid}`.
pub async fn genai_update_knowledge_base(configuration: &configuration::Configuration, uuid: &str, api_update_knowledge_base_input_public: Option<models::ApiUpdateKnowledgeBaseInputPublic>) -> Result<models::ApiUpdateKnowledgeBaseOutput, Error<GenaiUpdateKnowledgeBaseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_uuid = uuid;
...
pub async fn genai_update_model_api_key(configuration: &configuration::Configuration, api_key_uuid: &str, api_update_model_api_key_input_public: Option<models::ApiUpdateModelApiKeyInputPublic>) -> Result<models::ApiUpdateModelApiKeyOutput, Error<GenaiUpdateModelApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;
...
pub async fn genai_update_openai_api_key(configuration: &configuration::Configuration, api_key_uuid: &str, api_update_open_aiapi_key_input_public: Option<models::ApiUpdateOpenAiapiKeyInputPublic>) -> Result<models::ApiUpdateOpenAiapiKeyOutput, Error<GenaiUpdateOpenaiApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_api_key_uuid = api_key_uuid;
...
pub async fn genai_update_workspace(configuration: &configuration::Configuration, workspace_uuid: &str, api_update_workspace_input_public: Option<models::ApiUpdateWorkspaceInputPublic>) -> Result<models::ApiUpdateWorkspaceOutput, Error<GenaiUpdateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace_uuid = workspace_uuid;
