...
pub async fn registries_create(
    configuration: &configuration::Configuration,
    multiregistry_create: models::MultiregistryCreate,
) -> Result<models::RegistriesCreate201Response, Error<RegistriesCreateError>> {
...
pub async fn registries_delete(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<(), Error<RegistriesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        registry_name = crate::apis::urlencode(p_path_registry_name)
    );
    let mut req_builder = configuration
        .client
...
pub async fn registries_delete_repository(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
) -> Result<(), Error<RegistriesDeleteRepositoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        registry_name = crate::apis::urlencode(p_path_registry_name),
        repository_name = crate::apis::urlencode(p_path_repository_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn registries_delete_repository_manifest(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    manifest_digest: &str,
) -> Result<(), Error<RegistriesDeleteRepositoryManifestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
    ...
    let uri_str = format!(
        ...
        registry_name = crate::apis::urlencode(p_path_registry_name),
        repository_name = crate::apis::urlencode(p_path_repository_name),
        manifest_digest = crate::apis::urlencode(p_path_manifest_digest)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesDeleteRepositoryManifestError> =
...
pub async fn registries_delete_repository_tag(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    repository_tag: &str,
) -> Result<(), Error<RegistriesDeleteRepositoryTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
    ...
    let uri_str = format!(
        ...
        registry_name = crate::apis::urlencode(p_path_registry_name),
        repository_name = crate::apis::urlencode(p_path_repository_name),
        repository_tag = crate::apis::urlencode(p_path_repository_tag)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesDeleteRepositoryTagError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_get(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<models::RegistriesCreate201Response, Error<RegistriesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
...
pub async fn registries_get_docker_credentials(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<models::DockerCredentials, Error<RegistriesGetDockerCredentialsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesGetDockerCredentialsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_get_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistriesGetGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesGetGarbageCollectionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_get_options(
    configuration: &configuration::Configuration,
) -> Result<models::RegistriesGetOptions200Response, Error<RegistriesGetOptionsError>> {
...
pub async fn registries_get_subscription(
    configuration: &configuration::Configuration,
) -> Result<models::RegistriesGetSubscription200Response, Error<RegistriesGetSubscriptionError>> {
...
pub async fn registries_list(
    configuration: &configuration::Configuration,
) -> Result<models::RegistriesList200Response, Error<RegistriesListError>> {
    let uri_str = format!("{}/v2/registries", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn registries_list_garbage_collections(
    configuration: &configuration::Configuration,
    registry_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    models::RegistriesListGarbageCollections200Response,
    Error<RegistriesListGarbageCollectionsError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesListGarbageCollectionsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_list_repositories_v2(
    configuration: &configuration::Configuration,
    registry_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    page_token: Option<&str>,
) -> Result<models::RegistriesListRepositoriesV2200Response, Error<RegistriesListRepositoriesV2Error>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_query_per_page = per_page;
...
pub async fn registries_list_repository_manifests(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    per_page: Option<i32>,
    ...
    models::RegistriesListRepositoryManifests200Response,
    Error<RegistriesListRepositoryManifestsError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesListRepositoryManifestsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_list_repository_tags(
    configuration: &configuration::Configuration,
    registry_name: &str,
    repository_name: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::RegistriesListRepositoryTags200Response, Error<RegistriesListRepositoryTagsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    let p_path_repository_name = repository_name;
...
pub async fn registries_run_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
) -> Result<
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistriesRunGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesRunGarbageCollectionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_update_garbage_collection(
    configuration: &configuration::Configuration,
    registry_name: &str,
    garbage_collection_uuid: &str,
    update_registry: models::UpdateRegistry,
) -> Result<
    models::RegistriesGetGarbageCollection200Response,
    Error<RegistriesUpdateGarbageCollectionError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_registry_name = registry_name;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        registry_name = crate::apis::urlencode(p_path_registry_name),
        garbage_collection_uuid = crate::apis::urlencode(p_path_garbage_collection_uuid)
    );
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RegistriesUpdateGarbageCollectionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn registries_update_subscription(
    configuration: &configuration::Configuration,
    registries_update_subscription_request: Option<models::RegistriesUpdateSubscriptionRequest>,
) -> Result<models::RegistriesGetSubscription200Response, Error<RegistriesUpdateSubscriptionError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn registries_validate_name(
    configuration: &configuration::Configuration,
    validate_registry: models::ValidateRegistry,
) -> Result<(), Error<RegistriesValidateNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
