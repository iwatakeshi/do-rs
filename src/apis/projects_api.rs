...
pub async fn projects_create(configuration: &configuration::Configuration, project_base: models::ProjectBase) -> Result<models::ProjectsCreate201Response, Error<ProjectsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project_base = project_base;
    ...
    req_builder = req_builder.json(&p_body_project_base);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProjectsCreate201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProjectsCreate201Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn projects_delete(configuration: &configuration::Configuration, project_id: &str) -> Result<(), Error<ProjectsDeleteError>> {
    ...
    let uri_str = format!("{}/v2/projects/{project_id}", configuration.base_path, project_id=crate::apis::urlencode(p_path_project_id));
...
pub async fn projects_get(configuration: &configuration::Configuration, project_id: &str) -> Result<models::ProjectsCreate201Response, Error<ProjectsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
...
pub async fn projects_get_default(configuration: &configuration::Configuration, ) -> Result<models::ProjectsGetDefault200Response, Error<ProjectsGetDefaultError>> {

    let uri_str = format!("{}/v2/projects/default", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ProjectsGetDefault200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ProjectsGetDefault200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ProjectsGetDefaultError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all your projects, send a GET request to `/v2/projects`.
pub async fn projects_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>) -> Result<models::ProjectsList200Response, Error<ProjectsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn projects_patch(configuration: &configuration::Configuration, project_id: &str, project: models::Project) -> Result<models::ProjectsCreate201Response, Error<ProjectsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProjectsPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn projects_patch_default(configuration: &configuration::Configuration, project: models::Project) -> Result<models::ProjectsCreate201Response, Error<ProjectsPatchDefaultError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project = project;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProjectsPatchDefaultError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To update a project, send a PUT request to `/v2/projects/$PROJECT_ID`. All of the following attributes must be sent.
pub async fn projects_update(configuration: &configuration::Configuration, project_id: &str, project: models::Project) -> Result<models::ProjectsCreate201Response, Error<ProjectsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_body_project = project;
...
pub async fn projects_update_default(configuration: &configuration::Configuration, project: models::Project) -> Result<models::ProjectsCreate201Response, Error<ProjectsUpdateDefaultError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project = project;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProjectsUpdateDefaultError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
