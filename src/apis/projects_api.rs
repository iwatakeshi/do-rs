...
pub async fn projects_create(
    ...
    project_base: models::ProjectBase,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsCreateError>> {
...
pub async fn projects_delete(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<(), Error<ProjectsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn projects_get(
    configuration: &configuration::Configuration,
    project_id: &str,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
...
pub async fn projects_get_default(
    configuration: &configuration::Configuration,
) -> Result<models::ProjectsGetDefault200Response, Error<ProjectsGetDefaultError>> {
...
pub async fn projects_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ProjectsList200Response, Error<ProjectsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn projects_patch(
    configuration: &configuration::Configuration,
    project_id: &str,
    project: models::Project,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
...
pub async fn projects_patch_default(
    configuration: &configuration::Configuration,
    project: models::Project,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsPatchDefaultError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project = project;
...
pub async fn projects_update(
    ...
    project_id: &str,
    project: models::Project,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
    let p_body_project = project;
...
pub async fn projects_update_default(
    configuration: &configuration::Configuration,
    project: models::Project,
) -> Result<models::ProjectsCreate201Response, Error<ProjectsUpdateDefaultError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project = project;
