...
pub async fn image_actions_get(
    configuration: &configuration::Configuration,
    image_id: i32,
    action_id: i32,
) -> Result<models::Action, Error<ImageActionsGetError>> {
...
pub async fn image_actions_list(
    configuration: &configuration::Configuration,
    image_id: i32,
) -> Result<models::ActionsList200Response, Error<ImageActionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_image_id = image_id;
...
pub async fn image_actions_post(
    configuration: &configuration::Configuration,
    image_id: i32,
    image_actions_post_request: Option<models::ImageActionsPostRequest>,
) -> Result<models::Action, Error<ImageActionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_image_id = image_id;
