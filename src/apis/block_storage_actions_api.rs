...
pub async fn volume_actions_get(
    configuration: &configuration::Configuration,
    volume_id: &str,
    action_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsGetError>> {
...
pub async fn volume_actions_list(
    configuration: &configuration::Configuration,
    volume_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumeActionsList200Response, Error<VolumeActionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn volume_actions_post(
    configuration: &configuration::Configuration,
    volume_actions_post_request: models::VolumeActionsPostRequest,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn volume_actions_post_by_id(
    configuration: &configuration::Configuration,
    volume_id: &str,
    volume_actions_post_by_id_request: models::VolumeActionsPostByIdRequest,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsPostByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
