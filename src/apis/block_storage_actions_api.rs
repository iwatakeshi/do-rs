...
pub async fn volume_actions_get(configuration: &configuration::Configuration, volume_id: &str, action_id: i32, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsGetError>> {
    ...
    let uri_str = format!("{}/v2/volumes/{volume_id}/actions/{action_id}", configuration.base_path, volume_id=crate::apis::urlencode(p_path_volume_id), action_id=p_path_action_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumeActionsPost202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumeActionsPost202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VolumeActionsGetError> = serde_json::from_str(&content).ok();
...
pub async fn volume_actions_list(configuration: &configuration::Configuration, volume_id: &str, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumeActionsList200Response, Error<VolumeActionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    let p_query_per_page = per_page;
    let p_query_page = page;

    let uri_str = format!("{}/v2/volumes/{volume_id}/actions", configuration.base_path, volume_id=crate::apis::urlencode(p_path_volume_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumeActionsList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumeActionsList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VolumeActionsListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn volume_actions_post(configuration: &configuration::Configuration, volume_actions_post_request: models::VolumeActionsPostRequest, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_volume_actions_post_request = volume_actions_post_request;
    let p_query_per_page = per_page;
    let p_query_page = page;

    let uri_str = format!("{}/v2/volumes/actions", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_volume_actions_post_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumeActionsPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn volume_actions_post_by_id(configuration: &configuration::Configuration, volume_id: &str, volume_actions_post_by_id_request: models::VolumeActionsPostByIdRequest, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumeActionsPost202Response, Error<VolumeActionsPostByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    let p_body_volume_actions_post_by_id_request = volume_actions_post_by_id_request;
    let p_query_per_page = per_page;
    let p_query_page = page;
    ...
    req_builder = req_builder.json(&p_body_volume_actions_post_by_id_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumeActionsPostByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
