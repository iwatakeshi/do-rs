...
pub async fn vpcnatgateways_create(
    configuration: &configuration::Configuration,
    vpc_nat_gateway_create: Option<models::VpcNatGatewayCreate>,
) -> Result<models::VpcnatgatewaysCreate202Response, Error<VpcnatgatewaysCreateError>> {
...
pub async fn vpcnatgateways_delete(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<(), Error<VpcnatgatewaysDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn vpcnatgateways_get(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::VpcnatgatewaysGet200Response, Error<VpcnatgatewaysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn vpcnatgateways_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
    state: Option<&str>,
    ...
    r#type: Option<&str>,
    name: Option<&str>,
) -> Result<models::VpcnatgatewaysList200Response, Error<VpcnatgatewaysListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn vpcnatgateways_update(
    configuration: &configuration::Configuration,
    id: &str,
    vpc_nat_gateway_update: Option<models::VpcNatGatewayUpdate>,
) -> Result<models::VpcnatgatewaysUpdate200Response, Error<VpcnatgatewaysUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
