...
/// struct for typed errors of method [`vpcnatgateways_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcnatgatewaysCreateError {
...
/// struct for typed errors of method [`vpcnatgateways_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcnatgatewaysDeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`vpcnatgateways_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcnatgatewaysGetError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`vpcnatgateways_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcnatgatewaysListError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
/// struct for typed errors of method [`vpcnatgateways_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VpcnatgatewaysUpdateError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
pub async fn vpcnatgateways_create(configuration: &configuration::Configuration, vpc_nat_gateway_create: Option<models::VpcNatGatewayCreate>) -> Result<models::VpcnatgatewaysCreate202Response, Error<VpcnatgatewaysCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_vpc_nat_gateway_create = vpc_nat_gateway_create;

    let uri_str = format!("{}/v2/vpc_nat_gateways", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_vpc_nat_gateway_create);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcnatgatewaysCreate202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcnatgatewaysCreate202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcnatgatewaysCreateError> = serde_json::from_str(&content).ok();
...
pub async fn vpcnatgateways_delete(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<VpcnatgatewaysDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/v2/vpc_nat_gateways/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VpcnatgatewaysDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To show information about an individual VPC NAT gateway, send a GET request to `/v2/vpc_nat_gateways/$VPC_NAT_GATEWAY_ID`. 
pub async fn vpcnatgateways_get(configuration: &configuration::Configuration, id: &str) -> Result<models::VpcnatgatewaysGet200Response, Error<VpcnatgatewaysGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcnatgatewaysGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcnatgatewaysGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcnatgatewaysGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn vpcnatgateways_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>, state: Option<&str>, region: Option<&str>, r#type: Option<&str>, name: Option<&str>) -> Result<models::VpcnatgatewaysList200Response, Error<VpcnatgatewaysListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcnatgatewaysList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcnatgatewaysList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcnatgatewaysListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn vpcnatgateways_update(configuration: &configuration::Configuration, id: &str, vpc_nat_gateway_update: Option<models::VpcNatGatewayUpdate>) -> Result<models::VpcnatgatewaysUpdate200Response, Error<VpcnatgatewaysUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_vpc_nat_gateway_update = vpc_nat_gateway_update;
    ...
    req_builder = req_builder.json(&p_body_vpc_nat_gateway_update);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VpcnatgatewaysUpdate200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VpcnatgatewaysUpdate200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VpcnatgatewaysUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
