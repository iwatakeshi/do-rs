...
pub async fn vpcs_create(
    configuration: &configuration::Configuration,
    vpcs_create_request: models::VpcsCreateRequest,
) -> Result<models::VpcsCreate201Response, Error<VpcsCreateError>> {
...
pub async fn vpcs_create_peerings(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    vpcs_create_peerings_request: models::VpcsCreatePeeringsRequest,
) -> Result<models::VpcsCreatePeerings202Response, Error<VpcsCreatePeeringsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn vpcs_delete(
    configuration: &configuration::Configuration,
    vpc_id: &str,
) -> Result<(), Error<VpcsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
...
pub async fn vpcs_get(
    configuration: &configuration::Configuration,
    vpc_id: &str,
) -> Result<models::VpcsCreate201Response, Error<VpcsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
...
pub async fn vpcs_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VpcsList200Response, Error<VpcsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn vpcs_list_members(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    resource_type: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VpcsListMembers200Response, Error<VpcsListMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
...
pub async fn vpcs_list_peerings(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VpcsListPeerings200Response, Error<VpcsListPeeringsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn vpcs_patch(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    vpcs_patch_request: models::VpcsPatchRequest,
) -> Result<models::VpcsCreate201Response, Error<VpcsPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
...
pub async fn vpcs_patch_peerings(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    vpc_peering_id: &str,
    vpc_peering_updatable: models::VpcPeeringUpdatable,
) -> Result<models::VpcsCreatePeerings202Response, Error<VpcsPatchPeeringsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        vpc_id = crate::apis::urlencode(p_path_vpc_id),
        vpc_peering_id = crate::apis::urlencode(p_path_vpc_peering_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::PATCH, &uri_str);
...
pub async fn vpcs_update(
    configuration: &configuration::Configuration,
    vpc_id: &str,
    vpcs_update_request: models::VpcsUpdateRequest,
) -> Result<models::VpcsCreate201Response, Error<VpcsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_vpc_id = vpc_id;
