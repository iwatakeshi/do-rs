...
pub async fn tags_assign_resources(
    configuration: &configuration::Configuration,
    tag_id: &str,
    tags_resource: models::TagsResource,
) -> Result<(), Error<TagsAssignResourcesError>> {
...
pub async fn tags_create(
    configuration: &configuration::Configuration,
    tags: models::Tags,
) -> Result<models::TagsCreate201Response, Error<TagsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn tags_get(
    configuration: &configuration::Configuration,
    tag_id: &str,
) -> Result<models::TagsGet200Response, Error<TagsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_tag_id = tag_id;
...
pub async fn tags_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::TagsList200Response, Error<TagsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn tags_unassign_resources(
    configuration: &configuration::Configuration,
    tag_id: &str,
    tags_resource: models::TagsResource,
) -> Result<(), Error<TagsUnassignResourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_tag_id = tag_id;
    let p_body_tags_resource = tags_resource;
