...
pub async fn spaces_key_create(
    configuration: &configuration::Configuration,
    key: models::Key,
) -> Result<models::SpacesKeyCreate201Response, Error<SpacesKeyCreateError>> {
...
pub async fn spaces_key_delete(
    configuration: &configuration::Configuration,
    access_key: &str,
) -> Result<(), Error<SpacesKeyDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        access_key = crate::apis::urlencode(p_path_access_key)
    );
    let mut req_builder = configuration
        .client
...
pub async fn spaces_key_get(
    configuration: &configuration::Configuration,
    access_key: &str,
) -> Result<models::SpacesKeyGet200Response, Error<SpacesKeyGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
...
) -> Result<models::SpacesKeyList200Response, Error<SpacesKeyListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn spaces_key_patch(
    configuration: &configuration::Configuration,
    access_key: &str,
    key: models::Key,
) -> Result<models::SpacesKeyUpdate200Response, Error<SpacesKeyPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
    let p_body_key = key;
...
/// To update Spaces Access Key, send a PUT or PATCH request to `/v2/spaces/keys/$ACCESS_KEY`. At the moment, you cannot convert a fullaccess key to a scoped key or vice versa. You can only update the name of the key.
pub async fn spaces_key_update(
    configuration: &configuration::Configuration,
    access_key: &str,
    key: models::Key,
) -> Result<models::SpacesKeyUpdate200Response, Error<SpacesKeyUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
    let p_body_key = key;
