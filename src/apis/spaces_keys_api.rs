...
/// struct for typed errors of method [`spaces_key_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyCreateError {
...
/// struct for typed errors of method [`spaces_key_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyDeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`spaces_key_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyGetError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`spaces_key_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyListError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
/// struct for typed errors of method [`spaces_key_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyPatchError {
    Status400(models::Error),
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
...
/// struct for typed errors of method [`spaces_key_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SpacesKeyUpdateError {
    Status400(models::Error),
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
...
pub async fn spaces_key_create(configuration: &configuration::Configuration, key: models::Key) -> Result<models::SpacesKeyCreate201Response, Error<SpacesKeyCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_key = key;

    let uri_str = format!("{}/v2/spaces/keys", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SpacesKeyCreate201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SpacesKeyCreate201Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SpacesKeyCreateError> = serde_json::from_str(&content).ok();
...
pub async fn spaces_key_delete(configuration: &configuration::Configuration, access_key: &str) -> Result<(), Error<SpacesKeyDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;

    let uri_str = format!("{}/v2/spaces/keys/{access_key}", configuration.base_path, access_key=crate::apis::urlencode(p_path_access_key));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SpacesKeyDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn spaces_key_get(configuration: &configuration::Configuration, access_key: &str) -> Result<models::SpacesKeyGet200Response, Error<SpacesKeyGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SpacesKeyGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SpacesKeyGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SpacesKeyGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list Spaces Access Key, send a GET request to `/v2/spaces/keys`. Sort parameter must be used with Sort Direction. 
pub async fn spaces_key_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>, sort: Option<&str>, sort_direction: Option<&str>, name: Option<&str>, bucket: Option<&str>, permission: Option<&str>) -> Result<models::SpacesKeyList200Response, Error<SpacesKeyListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SpacesKeyList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SpacesKeyList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SpacesKeyListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn spaces_key_patch(configuration: &configuration::Configuration, access_key: &str, key: models::Key) -> Result<models::SpacesKeyUpdate200Response, Error<SpacesKeyPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
    let p_body_key = key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SpacesKeyUpdate200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SpacesKeyUpdate200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SpacesKeyPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To update Spaces Access Key, send a PUT or PATCH request to `/v2/spaces/keys/$ACCESS_KEY`. At the moment, you cannot convert a fullaccess key to a scoped key or vice versa. You can only update the name of the key. 
pub async fn spaces_key_update(configuration: &configuration::Configuration, access_key: &str, key: models::Key) -> Result<models::SpacesKeyUpdate200Response, Error<SpacesKeyUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_access_key = access_key;
    let p_body_key = key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SpacesKeyUpdateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
