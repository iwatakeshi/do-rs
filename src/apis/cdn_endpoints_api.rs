...
pub async fn cdn_create_endpoint(
    configuration: &configuration::Configuration,
    cdn_endpoint: models::CdnEndpoint,
) -> Result<models::CdnCreateEndpoint201Response, Error<CdnCreateEndpointError>> {
...
pub async fn cdn_delete_endpoint(
    configuration: &configuration::Configuration,
    cdn_id: &str,
) -> Result<(), Error<CdnDeleteEndpointError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        cdn_id = crate::apis::urlencode(p_path_cdn_id)
    );
    let mut req_builder = configuration
        .client
...
pub async fn cdn_get_endpoint(
    configuration: &configuration::Configuration,
    cdn_id: &str,
) -> Result<models::CdnCreateEndpoint201Response, Error<CdnGetEndpointError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_cdn_id = cdn_id;
...
pub async fn cdn_list_endpoints(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::CdnListEndpoints200Response, Error<CdnListEndpointsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn cdn_purge_cache(
    configuration: &configuration::Configuration,
    cdn_id: &str,
    purge_cache: models::PurgeCache,
) -> Result<(), Error<CdnPurgeCacheError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_cdn_id = cdn_id;
...
pub async fn cdn_update_endpoints(
    configuration: &configuration::Configuration,
    cdn_id: &str,
    update_endpoint: models::UpdateEndpoint,
) -> Result<models::CdnCreateEndpoint201Response, Error<CdnUpdateEndpointsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_cdn_id = cdn_id;
