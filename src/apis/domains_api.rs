...
pub async fn domains_create(
    ...
    domain: Option<models::Domain>,
) -> Result<models::DomainsCreate201Response, Error<DomainsCreateError>> {
...
pub async fn domains_delete(
    configuration: &configuration::Configuration,
    domain_name: &str,
) -> Result<(), Error<DomainsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn domains_get(
    configuration: &configuration::Configuration,
    domain_name: &str,
) -> Result<models::DomainsGet200Response, Error<DomainsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
...
pub async fn domains_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DomainsList200Response, Error<DomainsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
