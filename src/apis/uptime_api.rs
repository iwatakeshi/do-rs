...
pub async fn uptime_create_alert(
    configuration: &configuration::Configuration,
    check_id: &str,
    alert: models::Alert,
) -> Result<models::UptimeCreateAlert201Response, Error<UptimeCreateAlertError>> {
    ...
    let uri_str = format!(
        ...
        check_id = crate::apis::urlencode(p_path_check_id)
    );
...
pub async fn uptime_create_check(
    configuration: &configuration::Configuration,
    check_updatable: models::CheckUpdatable,
) -> Result<models::UptimeCreateCheck201Response, Error<UptimeCreateCheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn uptime_delete_alert(
    configuration: &configuration::Configuration,
    check_id: &str,
    alert_id: &str,
) -> Result<(), Error<UptimeDeleteAlertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
...
pub async fn uptime_delete_check(
    configuration: &configuration::Configuration,
    check_id: &str,
) -> Result<(), Error<UptimeDeleteCheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
...
pub async fn uptime_get_alert(
    configuration: &configuration::Configuration,
    check_id: &str,
    alert_id: &str,
) -> Result<models::UptimeCreateAlert201Response, Error<UptimeGetAlertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
    let p_path_alert_id = alert_id;
...
pub async fn uptime_get_check(
    configuration: &configuration::Configuration,
    check_id: &str,
) -> Result<models::UptimeCreateCheck201Response, Error<UptimeGetCheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
...
pub async fn uptime_get_check_state(
    configuration: &configuration::Configuration,
    check_id: &str,
) -> Result<models::UptimeGetCheckState200Response, Error<UptimeGetCheckStateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
...
pub async fn uptime_list_alerts(
    configuration: &configuration::Configuration,
    check_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::UptimeListAlerts200Response, Error<UptimeListAlertsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
...
pub async fn uptime_list_checks(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::UptimeListChecks200Response, Error<UptimeListChecksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn uptime_update_alert(
    configuration: &configuration::Configuration,
    check_id: &str,
    alert_id: &str,
    alert_updatable: models::AlertUpdatable,
) -> Result<models::UptimeCreateAlert201Response, Error<UptimeUpdateAlertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
    let p_path_alert_id = alert_id;
...
pub async fn uptime_update_check(
    configuration: &configuration::Configuration,
    check_id: &str,
    check_updatable: models::CheckUpdatable,
) -> Result<models::UptimeCreateCheck201Response, Error<UptimeUpdateCheckError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_check_id = check_id;
    let p_body_check_updatable = check_updatable;
