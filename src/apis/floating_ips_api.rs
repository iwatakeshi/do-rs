...
pub async fn floating_ips_create(
    configuration: &configuration::Configuration,
    floating_ip_create: models::FloatingIpCreate,
) -> Result<models::FloatingIpsCreate202Response, Error<FloatingIpsCreateError>> {
...
pub async fn floating_ips_delete(
    configuration: &configuration::Configuration,
    floating_ip: &str,
) -> Result<(), Error<FloatingIpsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        floating_ip = crate::apis::urlencode(p_path_floating_ip)
    );
    let mut req_builder = configuration
        .client
...
pub async fn floating_ips_get(
    configuration: &configuration::Configuration,
    floating_ip: &str,
) -> Result<models::FloatingIpsGet200Response, Error<FloatingIpsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_floating_ip = floating_ip;
...
pub async fn floating_ips_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::FloatingIpsList200Response, Error<FloatingIpsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
