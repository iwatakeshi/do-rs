...
pub async fn one_clicks_install_kubernetes(
    configuration: &configuration::Configuration,
    one_clicks_create: models::OneClicksCreate,
) -> Result<models::OneClicksInstallKubernetes200Response, Error<OneClicksInstallKubernetesError>> {
...
pub async fn one_clicks_list(
    configuration: &configuration::Configuration,
    r#type: Option<&str>,
) -> Result<models::OneClicksList200Response, Error<OneClicksListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
