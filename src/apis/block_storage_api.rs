...
pub async fn volume_snapshots_create(
    configuration: &configuration::Configuration,
    volume_id: &str,
    volume_snapshots_create_request: models::VolumeSnapshotsCreateRequest,
) -> Result<models::VolumeSnapshotsGetById200Response, Error<VolumeSnapshotsCreateError>> {
...
pub async fn volume_snapshots_delete_by_id(
    configuration: &configuration::Configuration,
    snapshot_id: &str,
) -> Result<(), Error<VolumeSnapshotsDeleteByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn volume_snapshots_get_by_id(
    configuration: &configuration::Configuration,
    snapshot_id: &str,
) -> Result<models::VolumeSnapshotsGetById200Response, Error<VolumeSnapshotsGetByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_snapshot_id = snapshot_id;
...
pub async fn volume_snapshots_list(
    configuration: &configuration::Configuration,
    volume_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumeSnapshotsList200Response, Error<VolumeSnapshotsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
...
pub async fn volumes_create(
    configuration: &configuration::Configuration,
    volumes_create_request: models::VolumesCreateRequest,
) -> Result<models::VolumesCreate201Response, Error<VolumesCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn volumes_delete(
    configuration: &configuration::Configuration,
    volume_id: &str,
) -> Result<(), Error<VolumesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
...
pub async fn volumes_delete_by_name(
    configuration: &configuration::Configuration,
    name: Option<&str>,
    region: Option<models::RegionSlug>,
) -> Result<(), Error<VolumesDeleteByNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn volumes_get(
    configuration: &configuration::Configuration,
    volume_id: &str,
) -> Result<models::VolumesCreate201Response, Error<VolumesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
...
pub async fn volumes_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::VolumesList200Response, Error<VolumesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_region = region;
    let p_query_per_page = per_page;
