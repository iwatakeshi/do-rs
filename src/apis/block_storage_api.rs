...
pub async fn volume_snapshots_create(configuration: &configuration::Configuration, volume_id: &str, volume_snapshots_create_request: models::VolumeSnapshotsCreateRequest) -> Result<models::VolumeSnapshotsGetById200Response, Error<VolumeSnapshotsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    let p_body_volume_snapshots_create_request = volume_snapshots_create_request;

    let uri_str = format!("{}/v2/volumes/{volume_id}/snapshots", configuration.base_path, volume_id=crate::apis::urlencode(p_path_volume_id));
    ...
    req_builder = req_builder.json(&p_body_volume_snapshots_create_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumeSnapshotsGetById200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumeSnapshotsGetById200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VolumeSnapshotsCreateError> = serde_json::from_str(&content).ok();
...
pub async fn volume_snapshots_delete_by_id(configuration: &configuration::Configuration, snapshot_id: &str) -> Result<(), Error<VolumeSnapshotsDeleteByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_snapshot_id = snapshot_id;

    let uri_str = format!("{}/v2/volumes/snapshots/{snapshot_id}", configuration.base_path, snapshot_id=crate::apis::urlencode(p_path_snapshot_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumeSnapshotsDeleteByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn volume_snapshots_get_by_id(configuration: &configuration::Configuration, snapshot_id: &str) -> Result<models::VolumeSnapshotsGetById200Response, Error<VolumeSnapshotsGetByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_snapshot_id = snapshot_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumeSnapshotsGetByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve the snapshots that have been created from a volume, send a GET request to `/v2/volumes/$VOLUME_ID/snapshots`.  
pub async fn volume_snapshots_list(configuration: &configuration::Configuration, volume_id: &str, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumeSnapshotsList200Response, Error<VolumeSnapshotsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumeSnapshotsList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumeSnapshotsList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<VolumeSnapshotsListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To create a new volume, send a POST request to `/v2/volumes`. Optionally, a `filesystem_type` attribute may be provided in order to automatically format the volume's filesystem. Pre-formatted volumes are automatically mounted when attached to Ubuntu, Debian, Fedora, Fedora Atomic, and CentOS Droplets created on or after April 26, 2018. Attaching pre-formatted volumes to Droplets without support for auto-mounting is not recommended.
pub async fn volumes_create(configuration: &configuration::Configuration, volumes_create_request: models::VolumesCreateRequest) -> Result<models::VolumesCreate201Response, Error<VolumesCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_volumes_create_request = volumes_create_request;

    let uri_str = format!("{}/v2/volumes", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_volumes_create_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumesCreate201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumesCreate201Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn volumes_delete(configuration: &configuration::Configuration, volume_id: &str) -> Result<(), Error<VolumesDeleteError>> {
    ...
    let uri_str = format!("{}/v2/volumes/{volume_id}", configuration.base_path, volume_id=crate::apis::urlencode(p_path_volume_id));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumesDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn volumes_delete_by_name(configuration: &configuration::Configuration, name: Option<&str>, region: Option<models::RegionSlug>) -> Result<(), Error<VolumesDeleteByNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumesDeleteByNameError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To show information about a block storage volume, send a GET request to `/v2/volumes/$VOLUME_ID`.  
pub async fn volumes_get(configuration: &configuration::Configuration, volume_id: &str) -> Result<models::VolumesCreate201Response, Error<VolumesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_volume_id = volume_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<VolumesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn volumes_list(configuration: &configuration::Configuration, name: Option<&str>, region: Option<models::RegionSlug>, per_page: Option<i32>, page: Option<i32>) -> Result<models::VolumesList200Response, Error<VolumesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_name = name;
    let p_query_region = region;
    let p_query_per_page = per_page;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::VolumesList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::VolumesList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
