...
pub async fn images_create_custom(
    configuration: &configuration::Configuration,
    image_new_custom: models::ImageNewCustom,
) -> Result<models::ImagesCreateCustom202Response, Error<ImagesCreateCustomError>> {
...
pub async fn images_delete(
    configuration: &configuration::Configuration,
    image_id: i32,
) -> Result<(), Error<ImagesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn images_get(
    configuration: &configuration::Configuration,
    image_id: &str,
) -> Result<models::ImagesGet200Response, Error<ImagesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_image_id = image_id;
...
pub async fn images_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ImagesList200Response, Error<ImagesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn images_update(
    configuration: &configuration::Configuration,
    image_id: i32,
    image_update: models::ImageUpdate,
) -> Result<models::ImagesGet200Response, Error<ImagesUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_image_id = image_id;
