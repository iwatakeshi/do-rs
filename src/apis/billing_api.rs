...
pub async fn balance_get(configuration: &configuration::Configuration, ) -> Result<models::Balance, Error<BalanceGetError>> {

    let uri_str = format!("{}/v2/customers/my/balance", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<BalanceGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve a list of all billing history entries, send a GET request to `/v2/customers/my/billing_history`.
pub async fn billing_history_list(configuration: &configuration::Configuration, ) -> Result<models::BillingHistoryList200Response, Error<BillingHistoryListError>> {

    let uri_str = format!("{}/v2/customers/my/billing_history", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BillingHistoryList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BillingHistoryList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn invoices_get_by_uuid(configuration: &configuration::Configuration, invoice_uuid: &str, per_page: Option<i32>, page: Option<i32>) -> Result<models::InvoicesGetByUuid200Response, Error<InvoicesGetByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;
    let p_query_per_page = per_page;
    let p_query_page = page;

    let uri_str = format!("{}/v2/customers/my/invoices/{invoice_uuid}", configuration.base_path, invoice_uuid=crate::apis::urlencode(p_path_invoice_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::InvoicesGetByUuid200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::InvoicesGetByUuid200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<InvoicesGetByUuidError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn invoices_get_csv_by_uuid(configuration: &configuration::Configuration, invoice_uuid: &str) -> Result<String, Error<InvoicesGetCsvByUuidError>> {
    ...
    let uri_str = format!("{}/v2/customers/my/invoices/{invoice_uuid}/csv", configuration.base_path, invoice_uuid=crate::apis::urlencode(p_path_invoice_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<InvoicesGetCsvByUuidError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve a PDF for an invoice, send a GET request to `/v2/customers/my/invoices/$INVOICE_UUID/pdf`.
pub async fn invoices_get_pdf_by_uuid(configuration: &configuration::Configuration, invoice_uuid: &str) -> Result<reqwest::Response, Error<InvoicesGetPdfByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;

    let uri_str = format!("{}/v2/customers/my/invoices/{invoice_uuid}/pdf", configuration.base_path, invoice_uuid=crate::apis::urlencode(p_path_invoice_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<InvoicesGetPdfByUuidError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve a summary for an invoice, send a GET request to `/v2/customers/my/invoices/$INVOICE_UUID/summary`.
pub async fn invoices_get_summary_by_uuid(configuration: &configuration::Configuration, invoice_uuid: &str) -> Result<models::InvoiceSummary, Error<InvoicesGetSummaryByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;

    let uri_str = format!("{}/v2/customers/my/invoices/{invoice_uuid}/summary", configuration.base_path, invoice_uuid=crate::apis::urlencode(p_path_invoice_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::InvoiceSummary`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::InvoiceSummary`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<InvoicesGetSummaryByUuidError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve a list of all invoices, send a GET request to `/v2/customers/my/invoices`.
pub async fn invoices_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>) -> Result<models::InvoicesList200Response, Error<InvoicesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_per_page = per_page;
    let p_query_page = page;

    let uri_str = format!("{}/v2/customers/my/invoices", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::InvoicesList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::InvoicesList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<InvoicesListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
