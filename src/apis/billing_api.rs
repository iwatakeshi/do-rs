...
) -> Result<models::Balance, Error<BalanceGetError>> {
...
pub async fn billing_history_list(
    configuration: &configuration::Configuration,
) -> Result<models::BillingHistoryList200Response, Error<BillingHistoryListError>> {
    let uri_str = format!(
...
pub async fn invoices_get_by_uuid(
    configuration: &configuration::Configuration,
    invoice_uuid: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::InvoicesGetByUuid200Response, Error<InvoicesGetByUuidError>> {
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        invoice_uuid = crate::apis::urlencode(p_path_invoice_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn invoices_get_csv_by_uuid(
    configuration: &configuration::Configuration,
    invoice_uuid: &str,
) -> Result<String, Error<InvoicesGetCsvByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;
...
pub async fn invoices_get_pdf_by_uuid(
    configuration: &configuration::Configuration,
    invoice_uuid: &str,
) -> Result<reqwest::Response, Error<InvoicesGetPdfByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;
...
pub async fn invoices_get_summary_by_uuid(
    configuration: &configuration::Configuration,
    invoice_uuid: &str,
) -> Result<models::InvoiceSummary, Error<InvoicesGetSummaryByUuidError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_invoice_uuid = invoice_uuid;
...
pub async fn invoices_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::InvoicesList200Response, Error<InvoicesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_per_page = per_page;
    let p_query_page = page;
