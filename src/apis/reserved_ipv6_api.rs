...
pub async fn reserved_ipv6_create(
    configuration: &configuration::Configuration,
    reserved_ipv6_create: models::ReservedIpv6Create,
) -> Result<models::ReservedIpv6Create201Response, Error<ReservedIpv6CreateError>> {
...
pub async fn reserved_ipv6_delete(
    configuration: &configuration::Configuration,
    reserved_ipv6: &str,
) -> Result<(), Error<ReservedIpv6DeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        reserved_ipv6 = crate::apis::urlencode(p_path_reserved_ipv6)
    );
    let mut req_builder = configuration
        .client
...
pub async fn reserved_ipv6_get(
    configuration: &configuration::Configuration,
    reserved_ipv6: &str,
) -> Result<models::ReservedIpv6Get200Response, Error<ReservedIpv6GetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ipv6 = reserved_ipv6;
...
pub async fn reserved_ipv6_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ReservedIpv6List200Response, Error<ReservedIpv6ListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
