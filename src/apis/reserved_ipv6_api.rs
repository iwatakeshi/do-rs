...
/// struct for typed errors of method [`reserved_ipv6_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpv6CreateError {
...
/// struct for typed errors of method [`reserved_ipv6_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpv6DeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`reserved_ipv6_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpv6GetError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`reserved_ipv6_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpv6ListError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
pub async fn reserved_ipv6_create(configuration: &configuration::Configuration, reserved_ipv6_create: models::ReservedIpv6Create) -> Result<models::ReservedIpv6Create201Response, Error<ReservedIpv6CreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_reserved_ipv6_create = reserved_ipv6_create;

    let uri_str = format!("{}/v2/reserved_ipv6", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_reserved_ipv6_create);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ReservedIpv6Create201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ReservedIpv6Create201Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ReservedIpv6CreateError> = serde_json::from_str(&content).ok();
...
pub async fn reserved_ipv6_delete(configuration: &configuration::Configuration, reserved_ipv6: &str) -> Result<(), Error<ReservedIpv6DeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ipv6 = reserved_ipv6;

    let uri_str = format!("{}/v2/reserved_ipv6/{reserved_ipv6}", configuration.base_path, reserved_ipv6=crate::apis::urlencode(p_path_reserved_ipv6));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReservedIpv6DeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To show information about a reserved IPv6, send a GET request to `/v2/reserved_ipv6/$RESERVED_IPV6`.
pub async fn reserved_ipv6_get(configuration: &configuration::Configuration, reserved_ipv6: &str) -> Result<models::ReservedIpv6Get200Response, Error<ReservedIpv6GetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_reserved_ipv6 = reserved_ipv6;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ReservedIpv6Get200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ReservedIpv6Get200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ReservedIpv6GetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To list all of the reserved IPv6s available on your account, send a GET request to `/v2/reserved_ipv6`.
pub async fn reserved_ipv6_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>) -> Result<models::ReservedIpv6List200Response, Error<ReservedIpv6ListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ReservedIpv6List200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ReservedIpv6List200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ReservedIpv6ListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
