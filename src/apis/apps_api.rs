...
pub async fn apps_assign_alert_destinations(configuration: &configuration::Configuration, app_id: &str, alert_id: &str, apps_assign_app_alert_destinations_request: models::AppsAssignAppAlertDestinationsRequest) -> Result<models::AppsAlertResponse, Error<AppsAssignAlertDestinationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_alert_id = alert_id;
    let p_body_apps_assign_app_alert_destinations_request = apps_assign_app_alert_destinations_request;

    let uri_str = format!("{}/v2/apps/{app_id}/alerts/{alert_id}/destinations", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), alert_id=crate::apis::urlencode(p_path_alert_id));
...
pub async fn apps_cancel_deployment(configuration: &configuration::Configuration, app_id: &str, deployment_id: &str) -> Result<models::AppsDeploymentResponse, Error<AppsCancelDeploymentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_deployment_id = deployment_id;

    let uri_str = format!("{}/v2/apps/{app_id}/deployments/{deployment_id}/cancel", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), deployment_id=crate::apis::urlencode(p_path_deployment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_commit_rollback(configuration: &configuration::Configuration, app_id: &str) -> Result<(), Error<AppsCommitRollbackError>> {
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/rollback/commit", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_create(configuration: &configuration::Configuration, apps_create_app_request: models::AppsCreateAppRequest, accept: Option<&str>, content_type: Option<&str>) -> Result<models::AppResponse, Error<AppsCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn apps_create_deployment(configuration: &configuration::Configuration, app_id: &str, apps_create_deployment_request: models::AppsCreateDeploymentRequest) -> Result<models::AppsDeploymentResponse, Error<AppsCreateDeploymentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_body_apps_create_deployment_request = apps_create_deployment_request;

    let uri_str = format!("{}/v2/apps/{app_id}/deployments", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_create_rollback(configuration: &configuration::Configuration, app_id: &str, apps_rollback_app_request: models::AppsRollbackAppRequest) -> Result<models::AppsDeploymentResponse, Error<AppsCreateRollbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_body_apps_rollback_app_request = apps_rollback_app_request;

    let uri_str = format!("{}/v2/apps/{app_id}/rollback", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_delete(configuration: &configuration::Configuration, id: &str) -> Result<models::AppsDeleteAppResponse, Error<AppsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/v2/apps/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
...
pub async fn apps_get(configuration: &configuration::Configuration, id: &str, name: Option<&str>) -> Result<models::AppResponse, Error<AppsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn apps_get_deployment(configuration: &configuration::Configuration, app_id: &str, deployment_id: &str) -> Result<models::AppsDeploymentResponse, Error<AppsGetDeploymentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_deployment_id = deployment_id;

    let uri_str = format!("{}/v2/apps/{app_id}/deployments/{deployment_id}", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), deployment_id=crate::apis::urlencode(p_path_deployment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_exec(configuration: &configuration::Configuration, app_id: &str, deployment_id: &str, component_name: &str, instance_name: Option<&str>) -> Result<models::AppsGetExecResponse, Error<AppsGetExecError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_deployment_id = deployment_id;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/deployments/{deployment_id}/components/{component_name}/exec", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), deployment_id=crate::apis::urlencode(p_path_deployment_id), component_name=crate::apis::urlencode(p_path_component_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_exec_active_deployment(configuration: &configuration::Configuration, app_id: &str, component_name: &str, instance_name: Option<&str>) -> Result<models::AppsGetExecResponse, Error<AppsGetExecActiveDeploymentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_component_name = component_name;
    let p_query_instance_name = instance_name;

    let uri_str = format!("{}/v2/apps/{app_id}/components/{component_name}/exec", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), component_name=crate::apis::urlencode(p_path_component_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_health(configuration: &configuration::Configuration, app_id: &str) -> Result<models::AppHealthResponse, Error<AppsGetHealthError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v2/apps/{app_id}/health", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_instance_size(configuration: &configuration::Configuration, slug: &str) -> Result<models::AppsGetInstanceSizeResponse, Error<AppsGetInstanceSizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_slug = slug;

    let uri_str = format!("{}/v2/apps/tiers/instance_sizes/{slug}", configuration.base_path, slug=crate::apis::urlencode(p_path_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_instances(configuration: &configuration::Configuration, app_id: &str) -> Result<models::AppInstances, Error<AppsGetInstancesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v2/apps/{app_id}/instances", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_job_invocation(configuration: &configuration::Configuration, app_id: &str, job_invocation_id: &str, job_name: Option<&str>) -> Result<models::AppJobInvocation, Error<AppsGetJobInvocationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_job_invocation_id = job_invocation_id;
    let p_query_job_name = job_name;

    let uri_str = format!("{}/v2/apps/{app_id}/job-invocations/{job_invocation_id}", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), job_invocation_id=crate::apis::urlencode(p_path_job_invocation_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_job_invocation_logs(configuration: &configuration::Configuration, app_id: &str, job_name: &str, job_invocation_id: &str, r#type: &str, deployment_id: Option<&str>, follow: Option<bool>, pod_connection_timeout: Option<&str>, tail_lines: Option<&str>) -> Result<models::AppsGetLogsResponse, Error<AppsGetJobInvocationLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/jobs/{job_name}/invocations/{job_invocation_id}/logs", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), job_name=crate::apis::urlencode(p_path_job_name), job_invocation_id=crate::apis::urlencode(p_path_job_invocation_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_logs(configuration: &configuration::Configuration, app_id: &str, deployment_id: &str, component_name: &str, r#type: &str, follow: Option<bool>, pod_connection_timeout: Option<&str>) -> Result<models::AppsGetLogsResponse, Error<AppsGetLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_deployment_id = deployment_id;
    let p_path_component_name = component_name;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/deployments/{deployment_id}/components/{component_name}/logs", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), deployment_id=crate::apis::urlencode(p_path_deployment_id), component_name=crate::apis::urlencode(p_path_component_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_logs_active_deployment(configuration: &configuration::Configuration, app_id: &str, component_name: &str, r#type: &str, follow: Option<bool>, pod_connection_timeout: Option<&str>) -> Result<models::AppsGetLogsResponse, Error<AppsGetLogsActiveDeploymentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_component_name = component_name;
    let p_query_type = r#type;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/components/{component_name}/logs", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), component_name=crate::apis::urlencode(p_path_component_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
/// Retrieve the logs of the active deployment if one exists. The response will include links to either real-time logs of an in-progress or active deployment or archived logs of a past deployment. Note log_type=BUILD logs will return logs associated with the current active deployment (being served). To view build logs associated with in-progress build, the query must explicitly reference the deployment id.
pub async fn apps_get_logs_active_deployment_aggregate(configuration: &configuration::Configuration, app_id: &str, r#type: &str, follow: Option<bool>, pod_connection_timeout: Option<&str>) -> Result<models::AppsGetLogsResponse, Error<AppsGetLogsActiveDeploymentAggregateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_query_type = r#type;
    let p_query_follow = follow;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/logs", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AppsGetLogsActiveDeploymentAggregateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn apps_get_logs_aggregate(configuration: &configuration::Configuration, app_id: &str, deployment_id: &str, r#type: &str, follow: Option<bool>, pod_connection_timeout: Option<&str>) -> Result<models::AppsGetLogsResponse, Error<AppsGetLogsAggregateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_deployment_id = deployment_id;
    let p_query_type = r#type;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/deployments/{deployment_id}/logs", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id), deployment_id=crate::apis::urlencode(p_path_deployment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_get_metrics_bandwidth_daily(configuration: &configuration::Configuration, app_id: &str, date: Option<String>) -> Result<models::AppMetricsBandwidthUsage, Error<AppsGetMetricsBandwidthDailyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_query_date = date;

    let uri_str = format!("{}/v2/apps/{app_id}/metrics/bandwidth_daily", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_list(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, with_projects: Option<bool>) -> Result<models::AppsResponse, Error<AppsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn apps_list_alerts(configuration: &configuration::Configuration, app_id: &str) -> Result<models::AppsListAlertsResponse, Error<AppsListAlertsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v2/apps/{app_id}/alerts", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn apps_list_deployments(configuration: &configuration::Configuration, app_id: &str, page: Option<i32>, per_page: Option<i32>, deployment_types: Option<Vec<String>>) -> Result<models::AppsDeploymentsResponse, Error<AppsListDeploymentsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_query_page = page;
    let p_query_per_page = per_page;
    ...
    if let Some(ref param_value) = p_query_deployment_types {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("deployment_types".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("deployment_types", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
...
pub async fn apps_list_instance_sizes(configuration: &configuration::Configuration, ) -> Result<models::AppsListInstanceSizesResponse, Error<AppsListInstanceSizesError>> {
...
pub async fn apps_list_job_invocations(configuration: &configuration::Configuration, app_id: &str, job_names: Option<Vec<String>>, deployment_id: Option<&str>, page: Option<i32>, per_page: Option<i32>) -> Result<models::AppJobInvocations, Error<AppsListJobInvocationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    ...
    let uri_str = format!("{}/v2/apps/{app_id}/job-invocations", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_job_names {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("job_names".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("job_names", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_deployment_id {
        req_builder = req_builder.query(&[("deployment_id", &param_value.to_string())]);
...
pub async fn apps_list_metrics_bandwidth_daily(configuration: &configuration::Configuration, app_metrics_bandwidth_usage_request: models::AppMetricsBandwidthUsageRequest) -> Result<models::AppMetricsBandwidthUsage, Error<AppsListMetricsBandwidthDailyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_app_metrics_bandwidth_usage_request = app_metrics_bandwidth_usage_request;

    let uri_str = format!("{}/v2/apps/metrics/bandwidth_daily", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AppsListMetricsBandwidthDailyError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// List all regions supported by App Platform.
pub async fn apps_list_regions(configuration: &configuration::Configuration, ) -> Result<models::AppsListRegionsResponse, Error<AppsListRegionsError>> {
...
pub async fn apps_restart(configuration: &configuration::Configuration, app_id: &str, apps_restart_request: Option<models::AppsRestartRequest>) -> Result<models::AppsDeploymentResponse, Error<AppsRestartError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_body_apps_restart_request = apps_restart_request;

    let uri_str = format!("{}/v2/apps/{app_id}/restart", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_revert_rollback(configuration: &configuration::Configuration, app_id: &str) -> Result<models::AppsDeploymentResponse, Error<AppsRevertRollbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v2/apps/{app_id}/rollback/revert", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn apps_update(configuration: &configuration::Configuration, id: &str, apps_update_app_request: models::AppsUpdateAppRequest) -> Result<models::AppResponse, Error<AppsUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn apps_validate_app_spec(configuration: &configuration::Configuration, app_propose: models::AppPropose) -> Result<models::AppProposeResponse, Error<AppsValidateAppSpecError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn apps_validate_rollback(configuration: &configuration::Configuration, app_id: &str, apps_rollback_app_request: models::AppsRollbackAppRequest) -> Result<models::AppsValidateRollback200Response, Error<AppsValidateRollbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_body_apps_rollback_app_request = apps_rollback_app_request;

    let uri_str = format!("{}/v2/apps/{app_id}/rollback/validate", configuration.base_path, app_id=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
