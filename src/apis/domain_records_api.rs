...
pub async fn domains_create_record(configuration: &configuration::Configuration, domain_name: &str, domains_create_record_request: Option<models::DomainsCreateRecordRequest>) -> Result<models::DomainsCreateRecord201Response, Error<DomainsCreateRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_body_domains_create_record_request = domains_create_record_request;

    let uri_str = format!("{}/v2/domains/{domain_name}/records", configuration.base_path, domain_name=crate::apis::urlencode(p_path_domain_name));
    ...
    req_builder = req_builder.json(&p_body_domains_create_record_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DomainsCreateRecord201Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DomainsCreateRecord201Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DomainsCreateRecordError> = serde_json::from_str(&content).ok();
...
pub async fn domains_delete_record(configuration: &configuration::Configuration, domain_name: &str, domain_record_id: i32) -> Result<(), Error<DomainsDeleteRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;

    let uri_str = format!("{}/v2/domains/{domain_name}/records/{domain_record_id}", configuration.base_path, domain_name=crate::apis::urlencode(p_path_domain_name), domain_record_id=p_path_domain_record_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DomainsDeleteRecordError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// To retrieve a specific domain record, send a GET request to `/v2/domains/$DOMAIN_NAME/records/$RECORD_ID`.
pub async fn domains_get_record(configuration: &configuration::Configuration, domain_name: &str, domain_record_id: i32) -> Result<models::DomainsGetRecord200Response, Error<DomainsGetRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DomainsGetRecord200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DomainsGetRecord200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DomainsGetRecordError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn domains_list_records(configuration: &configuration::Configuration, domain_name: &str, name: Option<&str>, r#type: Option<&str>, per_page: Option<i32>, page: Option<i32>) -> Result<models::DomainsListRecords200Response, Error<DomainsListRecordsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DomainsListRecords200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DomainsListRecords200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DomainsListRecordsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn domains_patch_record(configuration: &configuration::Configuration, domain_name: &str, domain_record_id: i32, domain_record: Option<models::DomainRecord>) -> Result<models::DomainsGetRecord200Response, Error<DomainsPatchRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
    let p_body_domain_record = domain_record;
    ...
    req_builder = req_builder.json(&p_body_domain_record);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DomainsPatchRecordError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn domains_update_record(configuration: &configuration::Configuration, domain_name: &str, domain_record_id: i32, domain_record: Option<models::DomainRecord>) -> Result<models::DomainsGetRecord200Response, Error<DomainsUpdateRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
    let p_body_domain_record = domain_record;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DomainsUpdateRecordError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
