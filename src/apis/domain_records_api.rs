...
pub async fn domains_create_record(
    configuration: &configuration::Configuration,
    domain_name: &str,
    domains_create_record_request: Option<models::DomainsCreateRecordRequest>,
) -> Result<models::DomainsCreateRecord201Response, Error<DomainsCreateRecordError>> {
    ...
    let uri_str = format!(
        ...
        domain_name = crate::apis::urlencode(p_path_domain_name)
    );
...
pub async fn domains_delete_record(
    configuration: &configuration::Configuration,
    domain_name: &str,
    domain_record_id: i32,
) -> Result<(), Error<DomainsDeleteRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        domain_name = crate::apis::urlencode(p_path_domain_name),
        domain_record_id = p_path_domain_record_id
    );
    let mut req_builder = configuration
        .client
...
pub async fn domains_get_record(
    configuration: &configuration::Configuration,
    domain_name: &str,
    domain_record_id: i32,
) -> Result<models::DomainsGetRecord200Response, Error<DomainsGetRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
...
pub async fn domains_list_records(
    configuration: &configuration::Configuration,
    domain_name: &str,
    name: Option<&str>,
    r#type: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DomainsListRecords200Response, Error<DomainsListRecordsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
...
pub async fn domains_patch_record(
    configuration: &configuration::Configuration,
    domain_name: &str,
    domain_record_id: i32,
    domain_record: Option<models::DomainRecord>,
) -> Result<models::DomainsGetRecord200Response, Error<DomainsPatchRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
...
pub async fn domains_update_record(
    configuration: &configuration::Configuration,
    domain_name: &str,
    domain_record_id: i32,
    domain_record: Option<models::DomainRecord>,
) -> Result<models::DomainsGetRecord200Response, Error<DomainsUpdateRecordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_domain_name = domain_name;
    let p_path_domain_record_id = domain_record_id;
    let p_body_domain_record = domain_record;
