...
pub async fn floating_ips_action_get(
    configuration: &configuration::Configuration,
    floating_ip: &str,
    action_id: i32,
) -> Result<models::FloatingIpsActionPost201Response, Error<FloatingIpsActionGetError>> {
...
pub async fn floating_ips_action_list(
    configuration: &configuration::Configuration,
    floating_ip: &str,
) -> Result<models::FloatingIpsActionList200Response, Error<FloatingIpsActionListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_floating_ip = floating_ip;
...
pub async fn floating_ips_action_post(
    configuration: &configuration::Configuration,
    floating_ip: &str,
    floating_ips_action_post_request: Option<models::FloatingIpsActionPostRequest>,
) -> Result<models::FloatingIpsActionPost201Response, Error<FloatingIpsActionPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_floating_ip = floating_ip;
