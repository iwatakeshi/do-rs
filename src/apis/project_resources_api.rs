...
pub async fn projects_assign_resources(
    configuration: &configuration::Configuration,
    project_id: &str,
    project_assignment: models::ProjectAssignment,
) -> Result<models::ProjectsAssignResources200Response, Error<ProjectsAssignResourcesError>> {
...
pub async fn projects_assign_resources_default(
    configuration: &configuration::Configuration,
    project_assignment: models::ProjectAssignment,
) -> Result<models::ProjectsAssignResources200Response, Error<ProjectsAssignResourcesDefaultError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_project_assignment = project_assignment;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ProjectsAssignResourcesDefaultError> =
...
pub async fn projects_list_resources(
    configuration: &configuration::Configuration,
    project_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ProjectsListResources200Response, Error<ProjectsListResourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_id = project_id;
...
pub async fn projects_list_resources_default(
    configuration: &configuration::Configuration,
) -> Result<models::ProjectsListResources200Response, Error<ProjectsListResourcesDefaultError>> {
    let uri_str = format!("{}/v2/projects/default/resources", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
