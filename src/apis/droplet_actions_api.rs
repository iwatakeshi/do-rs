...
pub async fn droplet_actions_get(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    action_id: i32,
) -> Result<models::ActionsGet200Response, Error<DropletActionsGetError>> {
...
pub async fn droplet_actions_list(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ActionsList200Response, Error<DropletActionsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
...
pub async fn droplet_actions_post(
    configuration: &configuration::Configuration,
    droplet_id: i32,
    droplet_actions_post_request: Option<models::DropletActionsPostRequest>,
) -> Result<models::ActionsGet200Response, Error<DropletActionsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_droplet_id = droplet_id;
...
pub async fn droplet_actions_post_by_tag(
    configuration: &configuration::Configuration,
    tag_name: Option<&str>,
    droplet_actions_post_by_tag_request: Option<models::DropletActionsPostByTagRequest>,
) -> Result<models::DropletActionsPostByTag201Response, Error<DropletActionsPostByTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
