...
pub async fn monitoring_create_alert_policy(
    configuration: &configuration::Configuration,
    alert_policy_request: models::AlertPolicyRequest,
) -> Result<models::MonitoringCreateAlertPolicy200Response, Error<MonitoringCreateAlertPolicyError>>
{
...
pub async fn monitoring_create_destination(
    configuration: &configuration::Configuration,
    destination_request: models::DestinationRequest,
) -> Result<models::MonitoringCreateDestination200Response, Error<MonitoringCreateDestinationError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn monitoring_create_sink(
    configuration: &configuration::Configuration,
    monitoring_create_sink_request: models::MonitoringCreateSinkRequest,
) -> Result<(), Error<MonitoringCreateSinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn monitoring_delete_alert_policy(
    configuration: &configuration::Configuration,
    alert_uuid: &str,
) -> Result<(), Error<MonitoringDeleteAlertPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        alert_uuid = crate::apis::urlencode(p_path_alert_uuid)
    );
    let mut req_builder = configuration
        .client
...
pub async fn monitoring_delete_destination(
    configuration: &configuration::Configuration,
    destination_uuid: &str,
) -> Result<(), Error<MonitoringDeleteDestinationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        destination_uuid = crate::apis::urlencode(p_path_destination_uuid)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn monitoring_delete_sink(
    configuration: &configuration::Configuration,
    sink_uuid: &str,
) -> Result<(), Error<MonitoringDeleteSinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        sink_uuid = crate::apis::urlencode(p_path_sink_uuid)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn monitoring_get_alert_policy(
    configuration: &configuration::Configuration,
    alert_uuid: &str,
) -> Result<models::MonitoringCreateAlertPolicy200Response, Error<MonitoringGetAlertPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_alert_uuid = alert_uuid;
...
pub async fn monitoring_get_app_cpu_percentage_metrics(
    configuration: &configuration::Configuration,
    app_id: &str,
    start: &str,
    end: &str,
    app_component: Option<&str>,
) -> Result<models::Metrics, Error<MonitoringGetAppCpuPercentageMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetAppCpuPercentageMetricsError> =
...
pub async fn monitoring_get_app_memory_percentage_metrics(
    configuration: &configuration::Configuration,
    app_id: &str,
    start: &str,
    end: &str,
    app_component: Option<&str>,
) -> Result<models::Metrics, Error<MonitoringGetAppMemoryPercentageMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_app_id = app_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetAppMemoryPercentageMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_app_restart_count_metrics_yml(
    configuration: &configuration::Configuration,
    app_id: &str,
    start: &str,
    end: &str,
    app_component: Option<&str>,
) -> Result<models::Metrics, Error<MonitoringGetAppRestartCountMetricsYmlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_app_id = app_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetAppRestartCountMetricsYmlError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_destination(
    configuration: &configuration::Configuration,
    destination_uuid: &str,
) -> Result<models::MonitoringCreateDestination200Response, Error<MonitoringGetDestinationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_destination_uuid = destination_uuid;
...
pub async fn monitoring_get_droplet_autoscale_current_cpu_utilization_yml(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleCurrentCpuUtilizationYmlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    req_builder =
        req_builder.query(&[("autoscale_pool_id", &p_query_autoscale_pool_id.to_string())]);
    req_builder = req_builder.query(&[("start", &p_query_start.to_string())]);
    req_builder = req_builder.query(&[("end", &p_query_end.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleCurrentCpuUtilizationYmlError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_autoscale_current_instances(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleCurrentInstancesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_autoscale_pool_id = autoscale_pool_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleCurrentInstancesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_autoscale_current_memory_utilization(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleCurrentMemoryUtilizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_autoscale_pool_id = autoscale_pool_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleCurrentMemoryUtilizationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_autoscale_target_cpu_utilization(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleTargetCpuUtilizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_autoscale_pool_id = autoscale_pool_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleTargetCpuUtilizationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_autoscale_target_instances(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleTargetInstancesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_autoscale_pool_id = autoscale_pool_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleTargetInstancesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_autoscale_target_memory_utilization(
    configuration: &configuration::Configuration,
    autoscale_pool_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletAutoscaleTargetMemoryUtilizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_autoscale_pool_id = autoscale_pool_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletAutoscaleTargetMemoryUtilizationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_bandwidth_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    interface: &str,
    direction: &str,
...
) -> Result<models::Metrics, Error<MonitoringGetDropletBandwidthMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletBandwidthMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_cpu_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletCpuMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletCpuMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_filesystem_free_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletFilesystemFreeMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletFilesystemFreeMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_filesystem_size_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletFilesystemSizeMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletFilesystemSizeMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_load15_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletLoad15MetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletLoad15MetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_load1_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletLoad1MetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletLoad1MetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_load5_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletLoad5MetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletLoad5MetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_memory_available_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletMemoryAvailableMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletMemoryAvailableMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_memory_cached_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletMemoryCachedMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletMemoryCachedMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_memory_free_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletMemoryFreeMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletMemoryFreeMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_droplet_memory_total_metrics(
    configuration: &configuration::Configuration,
    host_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetDropletMemoryTotalMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_host_id = host_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetDropletMemoryTotalMetricsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_connections(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsConnectionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsConnectionsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_downtime(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsDowntimeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsDowntimeError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_health_checks(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHealthChecksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHealthChecksError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_response_time50p(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpResponseTime50pError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpResponseTime50pError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_response_time95p(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpResponseTime95pError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpResponseTime95pError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_response_time99p(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpResponseTime99pError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpResponseTime99pError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_response_time_avg(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpResponseTimeAvgError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpResponseTimeAvgError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_responses(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpResponsesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpResponsesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_session_duration50p(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpSessionDuration50pError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpSessionDuration50pError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_session_duration95p(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpSessionDuration95pError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpSessionDuration95pError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_http_session_duration_avg(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsHttpSessionDurationAvgError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsHttpSessionDurationAvgError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_droplets_queue_size(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbDropletsQueueSizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbDropletsQueueSizeError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_connections_current(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendConnectionsCurrentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendConnectionsCurrentError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_connections_limit(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendConnectionsLimitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendConnectionsLimitError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_cpu_utilization(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendCpuUtilizationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendCpuUtilizationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_firewall_dropped_bytes(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendFirewallDroppedBytesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendFirewallDroppedBytesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_firewall_dropped_packets(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendFirewallDroppedPacketsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendFirewallDroppedPacketsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_http_requests_per_second(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendHttpRequestsPerSecondError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendHttpRequestsPerSecondError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_http_responses(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendHttpResponsesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendHttpResponsesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_network_throughput_http(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendNetworkThroughputHttpError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendNetworkThroughputHttpError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_network_throughput_tcp(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendNetworkThroughputTcpError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendNetworkThroughputTcpError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_network_throughput_udp(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendNetworkThroughputUdpError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendNetworkThroughputUdpError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_nlb_tcp_network_throughput(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendNlbTcpNetworkThroughputError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendNlbTcpNetworkThroughputError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_nlb_udp_network_throughput(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendNlbUdpNetworkThroughputError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendNlbUdpNetworkThroughputError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_tls_connections_current(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendTlsConnectionsCurrentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendTlsConnectionsCurrentError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_tls_connections_exceeding_rate_limit(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendTlsConnectionsExceedingRateLimitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendTlsConnectionsExceedingRateLimitError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_lb_frontend_tls_connections_limit(
    configuration: &configuration::Configuration,
    lb_id: &str,
    start: &str,
    end: &str,
) -> Result<models::Metrics, Error<MonitoringGetLbFrontendTlsConnectionsLimitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lb_id = lb_id;
    let p_query_start = start;
    let p_query_end = end;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<MonitoringGetLbFrontendTlsConnectionsLimitError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn monitoring_get_sink(
    configuration: &configuration::Configuration,
    sink_uuid: &str,
) -> Result<models::MonitoringGetSink200Response, Error<MonitoringGetSinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_sink_uuid = sink_uuid;
...
pub async fn monitoring_list_alert_policy(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::MonitoringListAlertPolicy200Response, Error<MonitoringListAlertPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn monitoring_list_destinations(
    configuration: &configuration::Configuration,
) -> Result<models::MonitoringListDestinations200Response, Error<MonitoringListDestinationsError>> {
    let uri_str = format!(
        "{}/v2/monitoring/sinks/destinations",
        configuration.base_path
    );
...
pub async fn monitoring_list_sinks(
    configuration: &configuration::Configuration,
    resource_id: Option<&str>,
) -> Result<models::MonitoringListSinks200Response, Error<MonitoringListSinksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn monitoring_update_alert_policy(
    configuration: &configuration::Configuration,
    alert_uuid: &str,
    alert_policy_request: models::AlertPolicyRequest,
) -> Result<models::MonitoringCreateAlertPolicy200Response, Error<MonitoringUpdateAlertPolicyError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_alert_uuid = alert_uuid;
    let p_body_alert_policy_request = alert_policy_request;
...
pub async fn monitoring_update_destination(
    configuration: &configuration::Configuration,
    destination_uuid: &str,
    destination_request: models::DestinationRequest,
) -> Result<(), Error<MonitoringUpdateDestinationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_destination_uuid = destination_uuid;
    let p_body_destination_request = destination_request;
