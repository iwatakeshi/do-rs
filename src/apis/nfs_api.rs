...
pub async fn nfs_create(
    configuration: &configuration::Configuration,
    nfs_request: models::NfsRequest,
) -> Result<models::NfsCreateResponse, Error<NfsCreateError>> {
...
pub async fn nfs_delete(
    configuration: &configuration::Configuration,
    nfs_id: &str,
    region: &str,
) -> Result<(), Error<NfsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        nfs_id = crate::apis::urlencode(p_path_nfs_id)
    );
    let mut req_builder = configuration
        .client
...
pub async fn nfs_delete_snapshot(
    configuration: &configuration::Configuration,
    nfs_snapshot_id: &str,
    region: &str,
) -> Result<(), Error<NfsDeleteSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        nfs_snapshot_id = crate::apis::urlencode(p_path_nfs_snapshot_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn nfs_get(
    configuration: &configuration::Configuration,
    nfs_id: &str,
    region: &str,
) -> Result<models::NfsGetResponse, Error<NfsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_nfs_id = nfs_id;
    let p_query_region = region;
...
pub async fn nfs_get_snapshot(
    configuration: &configuration::Configuration,
    nfs_snapshot_id: &str,
    region: &str,
) -> Result<models::NfsSnapshotGetResponse, Error<NfsGetSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_nfs_snapshot_id = nfs_snapshot_id;
    let p_query_region = region;
...
pub async fn nfs_list(
    configuration: &configuration::Configuration,
    region: &str,
) -> Result<models::NfsListResponse, Error<NfsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_region = region;
...
pub async fn nfs_list_snapshot(
    configuration: &configuration::Configuration,
    region: &str,
    share_id: Option<&str>,
) -> Result<models::NfsSnapshotListResponse, Error<NfsListSnapshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_region = region;
