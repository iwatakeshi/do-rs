...
pub async fn databases_add(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database: models::Database,
) -> Result<models::DatabasesAdd201Response, Error<DatabasesAddError>> {
    ...
    let uri_str = format!(
        ...
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid)
    );
...
pub async fn databases_add_connection_pool(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    connection_pool: models::ConnectionPool,
) -> Result<models::DatabasesAddConnectionPool201Response, Error<DatabasesAddConnectionPoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_add_user(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    databases_add_user_request: models::DatabasesAddUserRequest,
) -> Result<models::DatabasesAddUser201Response, Error<DatabasesAddUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_create_cluster(
    configuration: &configuration::Configuration,
    databases_create_cluster_request: models::DatabasesCreateClusterRequest,
) -> Result<models::DatabasesCreateCluster201Response, Error<DatabasesCreateClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn databases_create_kafka_schema(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_kafka_schema_create: models::DatabaseKafkaSchemaCreate,
) -> Result<models::KafkaSchemaVerbose, Error<DatabasesCreateKafkaSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_create_kafka_topic(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    kafka_topic_create: Option<models::KafkaTopicCreate>,
) -> Result<models::DatabasesCreateKafkaTopic201Response, Error<DatabasesCreateKafkaTopicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_create_logsink(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    logsink_create: models::LogsinkCreate,
) -> Result<models::DatabasesCreateLogsink201Response, Error<DatabasesCreateLogsinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_create_replica(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_replica: Option<models::DatabaseReplica>,
) -> Result<models::DatabasesCreateReplica201Response, Error<DatabasesCreateReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_delete(
    ...
    database_cluster_uuid: &str,
    database_name: &str,
) -> Result<(), Error<DatabasesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        database_name = crate::apis::urlencode(p_path_database_name)
    );
    let mut req_builder = configuration
        .client
...
pub async fn databases_delete_connection_pool(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    pool_name: &str,
) -> Result<(), Error<DatabasesDeleteConnectionPoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        pool_name = crate::apis::urlencode(p_path_pool_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesDeleteConnectionPoolError> =
...
pub async fn databases_delete_kafka_schema(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    subject_name: &str,
) -> Result<(), Error<DatabasesDeleteKafkaSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        subject_name = crate::apis::urlencode(p_path_subject_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn databases_delete_kafka_topic(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    topic_name: &str,
) -> Result<(), Error<DatabasesDeleteKafkaTopicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        topic_name = crate::apis::urlencode(p_path_topic_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn databases_delete_logsink(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    logsink_id: &str,
) -> Result<(), Error<DatabasesDeleteLogsinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        logsink_id = crate::apis::urlencode(p_path_logsink_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn databases_delete_online_migration(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    migration_id: &str,
) -> Result<(), Error<DatabasesDeleteOnlineMigrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        migration_id = crate::apis::urlencode(p_path_migration_id)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesDeleteOnlineMigrationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_delete_opensearch_index(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    index_name: &str,
) -> Result<(), Error<DatabasesDeleteOpensearchIndexError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesDeleteOpensearchIndexError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_delete_user(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    username: &str,
) -> Result<(), Error<DatabasesDeleteUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_destroy_cluster(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<(), Error<DatabasesDestroyClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_destroy_replica(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    replica_name: &str,
) -> Result<(), Error<DatabasesDestroyReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        database_cluster_uuid = crate::apis::urlencode(p_path_database_cluster_uuid),
        replica_name = crate::apis::urlencode(p_path_replica_name)
    );
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::DELETE, &uri_str);
...
pub async fn databases_get(
    ...
    database_cluster_uuid: &str,
    database_name: &str,
) -> Result<models::DatabasesAdd201Response, Error<DatabasesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_database_name = database_name;
...
pub async fn databases_get_autoscale(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesGetAutoscale200Response, Error<DatabasesGetAutoscaleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_ca(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesGetCa200Response, Error<DatabasesGetCaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_cluster(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesCreateCluster201Response, Error<DatabasesGetClusterError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_cluster_metrics_credentials(
    configuration: &configuration::Configuration,
) -> Result<
    models::DatabasesGetClusterMetricsCredentials200Response,
    Error<DatabasesGetClusterMetricsCredentialsError>,
> {
    let uri_str = format!(
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesGetClusterMetricsCredentialsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_get_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesGetConfig200Response, Error<DatabasesGetConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_connection_pool(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    pool_name: &str,
) -> Result<models::DatabasesAddConnectionPool201Response, Error<DatabasesGetConnectionPoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_pool_name = pool_name;
...
pub async fn databases_get_eviction_policy(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesGetEvictionPolicy200Response, Error<DatabasesGetEvictionPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_kafka_schema(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    subject_name: &str,
) -> Result<models::KafkaSchemaVersionVerbose, Error<DatabasesGetKafkaSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_subject_name = subject_name;
...
pub async fn databases_get_kafka_schema_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<
    models::DatabasesGetKafkaSchemaConfig200Response,
    Error<DatabasesGetKafkaSchemaConfigError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesGetKafkaSchemaConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_get_kafka_schema_subject_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    subject_name: &str,
) -> Result<
    models::DatabasesGetKafkaSchemaSubjectConfig200Response,
    Error<DatabasesGetKafkaSchemaSubjectConfigError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_subject_name = subject_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesGetKafkaSchemaSubjectConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_get_kafka_schema_version(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    subject_name: &str,
    version: &str,
) -> Result<models::KafkaSchemaVersionVerbose, Error<DatabasesGetKafkaSchemaVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_subject_name = subject_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesGetKafkaSchemaVersionError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_get_kafka_topic(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    topic_name: &str,
) -> Result<models::DatabasesCreateKafkaTopic201Response, Error<DatabasesGetKafkaTopicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_topic_name = topic_name;
...
pub async fn databases_get_logsink(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    logsink_id: &str,
) -> Result<models::LogsinkSchema, Error<DatabasesGetLogsinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_logsink_id = logsink_id;
...
pub async fn databases_get_migration_status(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::OnlineMigration, Error<DatabasesGetMigrationStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_replica(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    replica_name: &str,
) -> Result<models::DatabasesCreateReplica201Response, Error<DatabasesGetReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_replica_name = replica_name;
...
pub async fn databases_get_sql_mode(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::SqlMode, Error<DatabasesGetSqlModeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_get_user(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    username: &str,
) -> Result<models::DatabasesAddUser201Response, Error<DatabasesGetUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_username = username;
...
pub async fn databases_install_update(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<(), Error<DatabasesInstallUpdateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesList200Response, Error<DatabasesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_backups(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListBackups200Response, Error<DatabasesListBackupsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_clusters(
    configuration: &configuration::Configuration,
    tag_name: Option<&str>,
) -> Result<models::DatabasesListClusters200Response, Error<DatabasesListClustersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn databases_list_connection_pools(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::ConnectionPools, Error<DatabasesListConnectionPoolsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_events_logs(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListEventsLogs200Response, Error<DatabasesListEventsLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_firewall_rules(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListFirewallRules200Response, Error<DatabasesListFirewallRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_kafka_schemas(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListKafkaSchemas200Response, Error<DatabasesListKafkaSchemasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_kafka_topics(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListKafkaTopics200Response, Error<DatabasesListKafkaTopicsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_logsink(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListLogsink200Response, Error<DatabasesListLogsinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_opeasearch_indexes(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<
    models::DatabasesListOpeasearchIndexes200Response,
    Error<DatabasesListOpeasearchIndexesError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesListOpeasearchIndexesError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_list_options(
    configuration: &configuration::Configuration,
) -> Result<models::Options, Error<DatabasesListOptionsError>> {
...
pub async fn databases_list_replicas(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListReplicas200Response, Error<DatabasesListReplicasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_list_users(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
) -> Result<models::DatabasesListUsers200Response, Error<DatabasesListUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_patch_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_config: models::DatabaseConfig,
) -> Result<(), Error<DatabasesPatchConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_promote_replica(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    replica_name: &str,
) -> Result<(), Error<DatabasesPromoteReplicaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_replica_name = replica_name;
...
pub async fn databases_reset_auth(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    username: &str,
    databases_reset_auth_request: models::DatabasesResetAuthRequest,
) -> Result<models::DatabasesAddUser201Response, Error<DatabasesResetAuthError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_username = username;
...
pub async fn databases_update_autoscale(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_autoscale_params: models::DatabaseAutoscaleParams,
) -> Result<(), Error<DatabasesUpdateAutoscaleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_cluster_metrics_credentials(
    configuration: &configuration::Configuration,
    database_metrics_credentials: Option<models::DatabaseMetricsCredentials>,
) -> Result<(), Error<DatabasesUpdateClusterMetricsCredentialsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateClusterMetricsCredentialsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_cluster_size(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_cluster_resize: models::DatabaseClusterResize,
) -> Result<(), Error<DatabasesUpdateClusterSizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_connection_pool(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    pool_name: &str,
    connection_pool_update: models::ConnectionPoolUpdate,
) -> Result<(), Error<DatabasesUpdateConnectionPoolError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_pool_name = pool_name;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateConnectionPoolError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_eviction_policy(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    databases_update_eviction_policy_request: models::DatabasesUpdateEvictionPolicyRequest,
) -> Result<(), Error<DatabasesUpdateEvictionPolicyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateEvictionPolicyError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_firewall_rules(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    databases_update_firewall_rules_request: models::DatabasesUpdateFirewallRulesRequest,
) -> Result<(), Error<DatabasesUpdateFirewallRulesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_kafka_schema_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    databases_get_kafka_schema_config200_response: Option<
        models::DatabasesGetKafkaSchemaConfig200Response,
    >,
) -> Result<
    models::DatabasesGetKafkaSchemaConfig200Response,
    Error<DatabasesUpdateKafkaSchemaConfigError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_body_databases_get_kafka_schema_config200_response =
        databases_get_kafka_schema_config200_response;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateKafkaSchemaConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_kafka_schema_subject_config(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    subject_name: &str,
    databases_get_kafka_schema_config200_response: Option<
...
> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateKafkaSchemaSubjectConfigError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_kafka_topic(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    topic_name: &str,
    kafka_topic_update: Option<models::KafkaTopicUpdate>,
) -> Result<models::DatabasesCreateKafkaTopic201Response, Error<DatabasesUpdateKafkaTopicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_topic_name = topic_name;
...
pub async fn databases_update_logsink(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    logsink_id: &str,
    logsink_update: models::LogsinkUpdate,
) -> Result<(), Error<DatabasesUpdateLogsinkError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_logsink_id = logsink_id;
...
pub async fn databases_update_maintenance_window(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    database_maintenance_window: Option<models::DatabaseMaintenanceWindow>,
) -> Result<(), Error<DatabasesUpdateMaintenanceWindowError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateMaintenanceWindowError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_major_version(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    version2: models::Version2,
) -> Result<(), Error<DatabasesUpdateMajorVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_online_migration(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    source_database: models::SourceDatabase,
) -> Result<models::OnlineMigration, Error<DatabasesUpdateOnlineMigrationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DatabasesUpdateOnlineMigrationError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
pub async fn databases_update_region(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    databases_update_region_request: models::DatabasesUpdateRegionRequest,
) -> Result<(), Error<DatabasesUpdateRegionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_sql_mode(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    sql_mode: models::SqlMode,
) -> Result<(), Error<DatabasesUpdateSqlModeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
...
pub async fn databases_update_user(
    configuration: &configuration::Configuration,
    database_cluster_uuid: &str,
    username: &str,
    databases_update_user_request: models::DatabasesUpdateUserRequest,
) -> Result<models::DatabasesAddUser201Response, Error<DatabasesUpdateUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_database_cluster_uuid = database_cluster_uuid;
    let p_path_username = username;
