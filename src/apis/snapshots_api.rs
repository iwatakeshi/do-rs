...
pub async fn snapshots_delete(
    ...
    snapshot_id: &str,
) -> Result<(), Error<SnapshotsDeleteError>> {
...
pub async fn snapshots_get(
    configuration: &configuration::Configuration,
    snapshot_id: &str,
) -> Result<models::SnapshotsGet200Response, Error<SnapshotsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_snapshot_id = snapshot_id;
...
) -> Result<models::SnapshotsList200Response, Error<SnapshotsListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
