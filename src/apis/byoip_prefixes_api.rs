...
/// struct for typed errors of method [`byoip_prefixes_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesCreateError {
...
/// struct for typed errors of method [`byoip_prefixes_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesDeleteError {
    Status401(models::Error),
...
/// struct for typed errors of method [`byoip_prefixes_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesGetError {
    Status401(models::Error),
    Status404(models::Error),
    Status422(models::Error),
    Status429(models::Error),
...
/// struct for typed errors of method [`byoip_prefixes_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesListError {
    Status401(models::Error),
    Status429(models::Error),
    Status500(models::Error),
    DefaultResponse(models::Error),
...
/// struct for typed errors of method [`byoip_prefixes_list_resources`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesListResourcesError {
    Status401(models::Error),
    Status404(models::Error),
    Status429(models::Error),
    Status500(models::Error),
...
/// struct for typed errors of method [`byoip_prefixes_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ByoipPrefixesPatchError {
    Status401(models::Error),
    Status404(models::Error),
    Status422(models::Error),
    Status429(models::Error),
...
pub async fn byoip_prefixes_create(configuration: &configuration::Configuration, byoip_prefix_create: models::ByoipPrefixCreate) -> Result<models::ByoipPrefixesCreate202Response, Error<ByoipPrefixesCreateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_byoip_prefix_create = byoip_prefix_create;

    let uri_str = format!("{}/v2/byoip_prefixes", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_byoip_prefix_create);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ByoipPrefixesCreate202Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ByoipPrefixesCreate202Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesCreateError> = serde_json::from_str(&content).ok();
...
pub async fn byoip_prefixes_delete(configuration: &configuration::Configuration, byoip_prefix_uuid: &str) -> Result<(), Error<ByoipPrefixesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;

    let uri_str = format!("{}/v2/byoip_prefixes/{byoip_prefix_uuid}", configuration.base_path, byoip_prefix_uuid=crate::apis::urlencode(p_path_byoip_prefix_uuid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn byoip_prefixes_get(configuration: &configuration::Configuration, byoip_prefix_uuid: &str) -> Result<models::ByoipPrefixesGet200Response, Error<ByoipPrefixesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ByoipPrefixesGet200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ByoipPrefixesGet200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn byoip_prefixes_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>) -> Result<models::ByoipPrefixesList200Response, Error<ByoipPrefixesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ByoipPrefixesList200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ByoipPrefixesList200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesListError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn byoip_prefixes_list_resources(configuration: &configuration::Configuration, byoip_prefix_uuid: &str, per_page: Option<i32>, page: Option<i32>) -> Result<models::ByoipPrefixesListResources200Response, Error<ByoipPrefixesListResourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
    let p_query_per_page = per_page;
    let p_query_page = page;

    let uri_str = format!("{}/v2/byoip_prefixes/{byoip_prefix_uuid}/ips", configuration.base_path, byoip_prefix_uuid=crate::apis::urlencode(p_path_byoip_prefix_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ByoipPrefixesListResources200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ByoipPrefixesListResources200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesListResourcesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn byoip_prefixes_patch(configuration: &configuration::Configuration, byoip_prefix_uuid: &str, byoip_prefix_update: models::ByoipPrefixUpdate) -> Result<models::ByoipPrefixesGet200Response, Error<ByoipPrefixesPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
    let p_body_byoip_prefix_update = byoip_prefix_update;
    ...
    req_builder = req_builder.json(&p_body_byoip_prefix_update);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ByoipPrefixesPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
