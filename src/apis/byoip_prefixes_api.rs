...
pub async fn byoip_prefixes_create(
    configuration: &configuration::Configuration,
    byoip_prefix_create: models::ByoipPrefixCreate,
) -> Result<models::ByoipPrefixesCreate202Response, Error<ByoipPrefixesCreateError>> {
...
pub async fn byoip_prefixes_delete(
    configuration: &configuration::Configuration,
    byoip_prefix_uuid: &str,
) -> Result<(), Error<ByoipPrefixesDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let uri_str = format!(
        ...
        byoip_prefix_uuid = crate::apis::urlencode(p_path_byoip_prefix_uuid)
    );
    let mut req_builder = configuration
        .client
...
pub async fn byoip_prefixes_get(
    configuration: &configuration::Configuration,
    byoip_prefix_uuid: &str,
) -> Result<models::ByoipPrefixesGet200Response, Error<ByoipPrefixesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
...
pub async fn byoip_prefixes_list(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ByoipPrefixesList200Response, Error<ByoipPrefixesListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn byoip_prefixes_list_resources(
    configuration: &configuration::Configuration,
    byoip_prefix_uuid: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ByoipPrefixesListResources200Response, Error<ByoipPrefixesListResourcesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
    let p_query_per_page = per_page;
    let p_query_page = page;
...
pub async fn byoip_prefixes_patch(
    configuration: &configuration::Configuration,
    byoip_prefix_uuid: &str,
    byoip_prefix_update: models::ByoipPrefixUpdate,
) -> Result<models::ByoipPrefixesGet200Response, Error<ByoipPrefixesPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_byoip_prefix_uuid = byoip_prefix_uuid;
