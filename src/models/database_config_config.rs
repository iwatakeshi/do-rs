...
pub struct DatabaseConfigConfig {
    ...
    #[serde(rename = "mysql_incremental_backup", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "valkey_maxmemory_policy", skip_serializing_if = "Option::is_none")]
    pub valkey_maxmemory_policy: Option<models::EvictionPolicyModel>,
    /// Set output buffer limit for pub / sub clients in MB. The value is the hard limit, the soft limit is 1/4 of the hard limit. When setting the limit, be mindful of the available memory in the selected service plan.
    #[serde(rename = "valkey_pubsub_client_output_buffer_limit", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "valkey_number_of_databases", skip_serializing_if = "Option::is_none")]
    ...
    /// Counter logarithm factor for volatile-lfu and allkeys-lfu maxmemory-policies
    #[serde(rename = "valkey_lfu_log_factor", skip_serializing_if = "Option::is_none")]
    pub valkey_lfu_log_factor: Option<i32>,
    /// LFU maxmemory-policy counter decay time in minutes
    #[serde(rename = "valkey_lfu_decay_time", skip_serializing_if = "Option::is_none")]
    ...
    /// Set notify-keyspace-events option. Requires at least `K` or `E` and accepts any combination of the following options. Setting the parameter to `\"\"` disables notifications. - `K` &mdash; Keyspace events - `E` &mdash; Keyevent events - `g` &mdash; Generic commands (e.g. `DEL`, `EXPIRE`, `RENAME`, ...) - `$` &mdash; String commands - `l` &mdash; List commands - `s` &mdash; Set commands - `h` &mdash; Hash commands - `z` &mdash; Sorted set commands - `t` &mdash; Stream commands - `d` &mdash; Module key type events - `x` &mdash; Expired events - `e` &mdash; Evicted events - `m` &mdash; Key miss events - `n` &mdash; New key events - `A` &mdash; Alias for `\"g$lshztxed\"`
    #[serde(rename = "valkey_notify_keyspace_events", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "valkey_acl_channels_default", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "valkey_active_expire_effort", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "default_read_concern", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "default_write_concern", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "transaction_lifetime_limit_seconds", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "slow_op_threshold_ms", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "http_max_content_length_bytes", skip_serializing_if = "Option::is_none")]
    pub http_max_content_length_bytes: Option<i32>,
    /// Maximum size of allowed headers, in bytes.
    #[serde(rename = "http_max_header_size_bytes", skip_serializing_if = "Option::is_none")]
    pub http_max_header_size_bytes: Option<i32>,
    /// Maximum length of an HTTP URL, in bytes.
    #[serde(rename = "http_max_initial_line_length_bytes", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_fielddata_cache_size_percentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_memory_index_buffer_size_percentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_memory_min_index_buffer_size_mb", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_memory_max_index_buffer_size_mb", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_queries_cache_size_percentage", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "indices_recovery_max_mb_per_sec", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ism_history_max_age_hours", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ism_history_rollover_check_period_hours", skip_serializing_if = "Option::is_none")]
    pub ism_history_rollover_check_period_hours: Option<i32>,
    /// Length of time long audit history indices are kept, in days.
    #[serde(rename = "ism_history_rollover_retention_period_days", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "action_destructive_requires_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "reindex_remote_whitelist", skip_serializing_if = "Option::is_none")]
    pub reindex_remote_whitelist: Option<Vec<String>>,
    /// Enable or disable filtering of alerting by backend roles.
    #[serde(rename = "plugins_alerting_filter_by_backend_roles_enabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "keep_index_refresh_interval", skip_serializing_if = "Option::is_none")]
    pub keep_index_refresh_interval: Option<bool>,
}

impl DatabaseConfigConfig {
    pub fn new() -> DatabaseConfigConfig {
        DatabaseConfigConfig {
            backup_hour: None,
            backup_minute: None,
            sql_mode: None,
