...
pub struct DatabasesCreateClusterRequest {
    ...
    #[serde(
        rename = "schema_registry_connection",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "standby_private_connection",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "version_end_of_availability",
        skip_serializing_if = "Option::is_none"
    )]
