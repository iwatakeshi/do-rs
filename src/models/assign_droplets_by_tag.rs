...
pub struct AssignDropletsByTag {
    ...
    #[serde(
        rename = "http_idle_timeout_seconds",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "disable_lets_encrypt_dns_records",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "target_load_balancer_ids",
        skip_serializing_if = "Option::is_none"
    )]
...
impl AssignDropletsByTag {
    pub fn new(
        forwarding_rules: Vec<models::ForwardingRule>,
        tag: String,
        region: models::RegionSlug,
    ) -> AssignDropletsByTag {
        AssignDropletsByTag {
            id: None,
            name: None,
