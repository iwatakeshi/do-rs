...
/// ReservedIpv6ListReservedIpv6sInnerDroplet : Requires `droplet:read` scope.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ReservedIpv6ListReservedIpv6sInnerDroplet {
