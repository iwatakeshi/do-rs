...
pub struct AppSpec {
    ...
    #[serde(rename = "disable_edge_cache", skip_serializing_if = "Option::is_none")]
    pub disable_edge_cache: Option<bool>,
    ...
    #[serde(
        rename = "disable_email_obfuscation",
        skip_serializing_if = "Option::is_none"
    )]
    pub disable_email_obfuscation: Option<bool>,
    /// If set to `true`, suspicious requests will go through additional security checks to help mitigate layer 7 DDoS attacks.
    #[serde(
        rename = "enhanced_threat_control_enabled",
        skip_serializing_if = "Option::is_none"
    )]
    pub enhanced_threat_control_enabled: Option<bool>,
    /// A set of hostnames where the application will be available.
    #[serde(rename = "domains", skip_serializing_if = "Option::is_none")]
    pub domains: Option<Vec<models::AppDomainSpec>>,
    /// Workloads which expose publicly-accessible HTTP services.
    #[serde(rename = "services", skip_serializing_if = "Option::is_none")]
    pub services: Option<Vec<models::AppServiceSpec>>,
    /// Content which can be rendered to static web assets.
    #[serde(rename = "static_sites", skip_serializing_if = "Option::is_none")]
    pub static_sites: Option<Vec<models::AppStaticSiteSpec>>,
    ...
    pub functions: Option<Vec<models::AppFunctionsSpec>>,
...
impl AppSpec {
    ...
    pub fn new(name: String) -> AppSpec {
        AppSpec {
            name,
            region: None,
            disable_edge_cache: None,
            disable_email_obfuscation: None,
            enhanced_threat_control_enabled: None,
            domains: None,
            services: None,
            static_sites: None,
            jobs: None,
