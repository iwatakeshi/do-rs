...
/// ReservedIpDroplet : The Droplet that the reserved IP has been assigned to. When you query a reserved IP, if it is assigned to a Droplet, the entire Droplet object will be returned. If it is not assigned, the value will be null.<br><br>Requires `droplet:read` scope.
...
pub struct ReservedIpDroplet {
    ...
    #[serde(rename = "status")]
    pub status: Status,
    #[serde(rename = "kernel", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub kernel: Option<Option<Box<models::Kernel>>>,
    ...
    #[serde(rename = "next_backup_window", deserialize_with = "Option::deserialize")]
    pub next_backup_window: Option<Box<models::DropletNextBackupWindow>>,
    ...
    pub gpu_info: Option<Box<models::GpuInfo>>,
}
...
impl ReservedIpDroplet {
    ...
    pub fn new(id: i32, name: String, memory: i32, vcpus: i32, disk: i32, locked: bool, status: Status, created_at: String, features: Vec<String>, backup_ids: Vec<i32>, next_backup_window: Option<models::DropletNextBackupWindow>, snapshot_ids: Vec<i32>, image: models::Image, volume_ids: Vec<String>, size: models::Size, size_slug: String, networks: models::DropletNetworks, region: models::Region, tags: Vec<String>) -> ReservedIpDroplet {
        ReservedIpDroplet {
            id,
            name,
            memory,
