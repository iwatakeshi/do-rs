...
pub struct AssignDropletsById {
    ...
    pub forwarding_rules: Vec<models::ForwardingRule>,
    ...
    pub sticky_sessions: Option<Box<models::StickySessions>>,
    ...
    #[serde(rename = "http_idle_timeout_seconds", skip_serializing_if = "Option::is_none")]
    pub http_idle_timeout_seconds: Option<i32>,
    ...
    pub firewall: Option<Box<models::LbFirewall>>,
    ...
    #[serde(rename = "network_stack", skip_serializing_if = "Option::is_none")]
    ...
    pub domains: Option<Vec<models::Domains>>,
    #[serde(rename = "glb_settings", skip_serializing_if = "Option::is_none")]
    pub glb_settings: Option<Box<models::GlbSettings>>,
    /// An array containing the UUIDs of the Regional load balancers to be used as target backends for a Global load balancer.
    #[serde(rename = "target_load_balancer_ids", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "tls_cipher_policy", skip_serializing_if = "Option::is_none")]
    pub tls_cipher_policy: Option<TlsCipherPolicy>,
    /// An array containing the IDs of the Droplets assigned to the load balancer.
    #[serde(rename = "droplet_ids")]
    pub droplet_ids: Vec<i32>,
    #[serde(rename = "region")]
    pub region: models::RegionSlug,
}

impl AssignDropletsById {
    pub fn new(forwarding_rules: Vec<models::ForwardingRule>, droplet_ids: Vec<i32>, region: models::RegionSlug) -> AssignDropletsById {
        AssignDropletsById {
            id: None,
            name: None,
            project_id: None,
            ...
            http_idle_timeout_seconds: None,
            vpc_uuid: None,
...
impl Default for TlsCipherPolicy {
    fn default() -> TlsCipherPolicy {
        Self::Default
    }
}
