...
pub struct KafkaTopicConfig {
    ...
    #[serde(rename = "delete_retention_ms", skip_serializing_if = "Option::is_none")]
    pub delete_retention_ms: Option<i32>,
    /// The file_delete_delay_ms specifies the time (in ms) to wait before deleting a file from the filesystem.
    #[serde(rename = "file_delete_delay_ms", skip_serializing_if = "Option::is_none")]
    pub file_delete_delay_ms: Option<i32>,
    ...
    #[serde(rename = "max_compaction_lag_ms", skip_serializing_if = "Option::is_none")]
    pub max_compaction_lag_ms: Option<i32>,
    ...
    #[serde(rename = "message_down_conversion_enable", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "message_format_version", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "message_timestamp_type", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "min_cleanable_dirty_ratio", skip_serializing_if = "Option::is_none")]
    pub min_cleanable_dirty_ratio: Option<f32>,
    ...
    #[serde(rename = "min_compaction_lag_ms", skip_serializing_if = "Option::is_none")]
    pub min_compaction_lag_ms: Option<i32>,
    ...
    pub retention_bytes: Option<i32>,
    ...
    pub segment_jitter_ms: Option<i32>,
    ...
    pub segment_ms: Option<i32>,
}

impl KafkaTopicConfig {
    pub fn new() -> KafkaTopicConfig {
        KafkaTopicConfig {
            cleanup_policy: None,
            ...
            message_down_conversion_enable: None,
