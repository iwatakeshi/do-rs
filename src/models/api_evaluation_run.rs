...
pub struct ApiEvaluationRun {
    ...
    /// Version hash
    #[serde(rename = "agent_version_hash", skip_serializing_if = "Option::is_none")]
    pub agent_version_hash: Option<String>,
    /// Agent workspace uuid
    #[serde(
        rename = "agent_workspace_uuid",
        skip_serializing_if = "Option::is_none"
    )]
    pub agent_workspace_uuid: Option<String>,
    #[serde(
        rename = "created_by_user_email",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(rename = "pass_status", skip_serializing_if = "Option::is_none")]
    pub pass_status: Option<bool>,
    /// Run queued time.
    #[serde(rename = "queued_at", skip_serializing_if = "Option::is_none")]
    pub queued_at: Option<String>,
    #[serde(
        rename = "run_level_metric_results",
        skip_serializing_if = "Option::is_none"
    )]
    pub run_level_metric_results: Option<Vec<models::ApiEvaluationMetricResult>>,
    /// Run name.
    #[serde(rename = "run_name", skip_serializing_if = "Option::is_none")]
    pub run_name: Option<String>,
    #[serde(rename = "star_metric_result", skip_serializing_if = "Option::is_none")]
    pub star_metric_result: Option<Box<models::ApiEvaluationMetricResult>>,
    /// Run start time.
    #[serde(rename = "started_at", skip_serializing_if = "Option::is_none")]
    pub started_at: Option<String>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<models::ApiEvaluationRunStatus>,
    /// Test case description.
    #[serde(
        rename = "test_case_description",
        skip_serializing_if = "Option::is_none"
    )]
    pub test_case_description: Option<String>,
    /// Test case name.
    #[serde(rename = "test_case_name", skip_serializing_if = "Option::is_none")]
    ...
    /// Test-case-version.
    #[serde(rename = "test_case_version", skip_serializing_if = "Option::is_none")]
    pub test_case_version: Option<i64>,
}

impl ApiEvaluationRun {
    pub fn new() -> ApiEvaluationRun {
        ApiEvaluationRun {
            ...
            agent_workspace_uuid: None,
            created_by_user_email: None,
            created_by_user_id: None,
            error_description: None,
            evaluation_run_uuid: None,
            evaluation_test_case_workspace_uuid: None,
            finished_at: None,
            pass_status: None,
            queued_at: None,
            run_level_metric_results: None,
            run_name: None,
            star_metric_result: None,
            started_at: None,
            status: None,
