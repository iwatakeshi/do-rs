...
#[serde(untagged)]
pub enum LoadBalancerCreate {
    AssignDropletsById(Box<models::AssignDropletsById>),
    AssignDropletsByTag(Box<models::AssignDropletsByTag>),
}

impl Default for LoadBalancerCreate {
    fn default() -> Self {
        Self::AssignDropletsById(Default::default())
    }
}
