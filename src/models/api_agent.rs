...
pub struct ApiAgent {
    ...
    pub anthropic_api_key: Option<Box<models::ApiAnthropicApiKeyInfo>>,
    /// Api key infos
    #[serde(rename = "api_key_infos", skip_serializing_if = "Option::is_none")]
    pub api_key_infos: Option<Vec<models::ApiAgentApiKeyInfo>>,
    /// Api keys
    #[serde(rename = "api_keys", skip_serializing_if = "Option::is_none")]
    pub api_keys: Option<Vec<models::ApiAgentApiKey>>,
    #[serde(rename = "chatbot", skip_serializing_if = "Option::is_none")]
    pub chatbot: Option<Box<models::ApiChatbot>>,
    /// Chatbot identifiers
    #[serde(rename = "chatbot_identifiers", skip_serializing_if = "Option::is_none")]
    pub chatbot_identifiers: Option<Vec<models::ApiAgentChatbotIdentifier>>,
    /// Child agents
    #[serde(rename = "child_agents", skip_serializing_if = "Option::is_none")]
    pub child_agents: Option<Vec<models::ApiAgent>>,
    /// Whether conversation logs are enabled for the agent
    #[serde(rename = "conversation_logs_enabled", skip_serializing_if = "Option::is_none")]
    pub conversation_logs_enabled: Option<bool>,
    /// Creation date / time
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    #[serde(rename = "deployment", skip_serializing_if = "Option::is_none")]
    pub deployment: Option<Box<models::ApiDeployment>>,
    /// Description of agent
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    #[serde(rename = "functions", skip_serializing_if = "Option::is_none")]
    pub functions: Option<Vec<models::ApiAgentFunction>>,
    /// The guardrails the agent is attached to
    #[serde(rename = "guardrails", skip_serializing_if = "Option::is_none")]
    pub guardrails: Option<Vec<models::ApiAgentGuardrail>>,
    #[serde(rename = "if_case", skip_serializing_if = "Option::is_none")]
    ...
    pub knowledge_bases: Option<Vec<models::ApiKnowledgeBase>>,
    #[serde(rename = "logging_config", skip_serializing_if = "Option::is_none")]
    pub logging_config: Option<Box<models::ApiAgentLoggingConfig>>,
    #[serde(rename = "max_tokens", skip_serializing_if = "Option::is_none")]
    pub max_tokens: Option<i64>,
    #[serde(rename = "model", skip_serializing_if = "Option::is_none")]
    pub model: Option<Box<models::ApiModel>>,
    #[serde(rename = "model_provider_key", skip_serializing_if = "Option::is_none")]
    pub model_provider_key: Option<Box<models::ApiModelProviderKeyInfo>>,
    /// Agent name
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "openai_api_key", skip_serializing_if = "Option::is_none")]
    pub openai_api_key: Option<Box<models::ApiOpenAiapiKeyInfo>>,
    /// Parent agents
    #[serde(rename = "parent_agents", skip_serializing_if = "Option::is_none")]
    pub parent_agents: Option<Vec<models::ApiAgent>>,
    #[serde(rename = "project_id", skip_serializing_if = "Option::is_none")]
    pub project_id: Option<String>,
    /// Whether the agent should provide in-response citations
    #[serde(rename = "provide_citations", skip_serializing_if = "Option::is_none")]
    pub provide_citations: Option<bool>,
    /// Region code
    #[serde(rename = "region", skip_serializing_if = "Option::is_none")]
    pub region: Option<String>,
    #[serde(rename = "retrieval_method", skip_serializing_if = "Option::is_none")]
    pub retrieval_method: Option<models::ApiRetrievalMethod>,
    /// Creation of route date / time
    #[serde(rename = "route_created_at", skip_serializing_if = "Option::is_none")]
    pub route_created_at: Option<String>,
    #[serde(rename = "route_created_by", skip_serializing_if = "Option::is_none")]
    pub route_created_by: Option<String>,
    /// Route name
    #[serde(rename = "route_name", skip_serializing_if = "Option::is_none")]
    pub route_name: Option<String>,
    #[serde(rename = "route_uuid", skip_serializing_if = "Option::is_none")]
    ...
    pub template: Option<Box<models::ApiAgentTemplate>>,
    ...
    #[serde(rename = "version_hash", skip_serializing_if = "Option::is_none")]
    pub version_hash: Option<String>,
    /// VPC Egress IPs
    #[serde(rename = "vpc_egress_ips", skip_serializing_if = "Option::is_none")]
    pub vpc_egress_ips: Option<Vec<String>>,
    ...
    pub workspace: Option<Box<models::ApiWorkspace>>,
}
...
impl ApiAgent {
    ...
    pub fn new() -> ApiAgent {
        ApiAgent {
            ...
            api_keys: None,
            chatbot: None,
            chatbot_identifiers: None,
            child_agents: None,
            conversation_logs_enabled: None,
            created_at: None,
            deployment: None,
            description: None,
            functions: None,
