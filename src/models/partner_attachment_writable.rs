...
pub struct PartnerAttachmentWritable {
    ...
    #[serde(rename = "connection_bandwidth_in_mbps")]
    pub connection_bandwidth_in_mbps: ConnectionBandwidthInMbps,
    /// The region to create the partner attachment.
    #[serde(rename = "region")]
    pub region: Region,
    #[serde(rename = "naas_provider")]
    ...
    pub bgp: Option<Box<models::PartnerAttachmentWritableBgp>>,
    /// Optional redundancy zone for the partner attachment.
    #[serde(rename = "redundancy_zone", skip_serializing_if = "Option::is_none")]
    pub redundancy_zone: Option<RedundancyZone>,
}

impl PartnerAttachmentWritable {
    pub fn new(
        name: String,
...
pub enum ConnectionBandwidthInMbps {
    #[serde(rename = "1000")]
    Variant1000,
    #[serde(rename = "2000")]
    Variant2000,
...
impl Default for ConnectionBandwidthInMbps {
    fn default() -> ConnectionBandwidthInMbps {
        Self::Variant1000
    }
}
/// The region to create the partner attachment.
...
/// Optional redundancy zone for the partner attachment.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum RedundancyZone {
    #[serde(rename = "MEGAPORT_BLUE")]
    MegaportBlue,
    #[serde(rename = "MEGAPORT_RED")]
    MegaportRed,
}

impl Default for RedundancyZone {
    fn default() -> RedundancyZone {
        Self::MegaportBlue
    }
}
