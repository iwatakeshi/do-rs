...
pub struct DropletBackupPolicy {
    ...
    #[serde(
        rename = "window_length_hours",
        skip_serializing_if = "Option::is_none"
    )]
    pub window_length_hours: Option<i32>,
    /// The number of days the backup will be retained.
    #[serde(
        rename = "retention_period_days",
        skip_serializing_if = "Option::is_none"
    )]
    pub retention_period_days: Option<i32>,
}

impl DropletBackupPolicy {
    pub fn new() -> DropletBackupPolicy {
        DropletBackupPolicy {
            plan: None,
            weekday: None,
            hour: None,
            window_length_hours: None,
