...
pub struct VpcNatGatewayGet {
    ...
    pub vpcs: Option<Vec<models::VpcNatGatewayGetVpcsInner>>,
    #[serde(rename = "egresses", skip_serializing_if = "Option::is_none")]
    pub egresses: Option<Box<models::VpcNatGatewayGetEgresses>>,
    /// The UDP timeout in seconds for the VPC NAT gateway.
    #[serde(rename = "udp_timeout_seconds", skip_serializing_if = "Option::is_none")]
    pub udp_timeout_seconds: Option<i32>,
    /// The ICMP timeout in seconds for the VPC NAT gateway.
    #[serde(rename = "icmp_timeout_seconds", skip_serializing_if = "Option::is_none")]
    pub icmp_timeout_seconds: Option<i32>,
    /// The TCP timeout in seconds for the VPC NAT gateway.
    #[serde(rename = "tcp_timeout_seconds", skip_serializing_if = "Option::is_none")]
...
impl VpcNatGatewayGet {
    pub fn new() -> VpcNatGatewayGet {
        VpcNatGatewayGet {
            id: None,
            name: None,
            r#type: None,
