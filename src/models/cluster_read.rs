...
pub struct ClusterRead {
    ...
    #[serde(rename = "cluster_subnet", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "service_subnet", skip_serializing_if = "Option::is_none")]
    ...
    pub node_pools: Vec<models::KubernetesNodePool>,
    #[serde(
        rename = "maintenance_policy",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub maintenance_policy: Option<Option<Box<models::MaintenancePolicy>>>,
    /// A boolean value indicating whether the cluster will be automatically upgraded to new patch releases during its maintenance window.
    #[serde(rename = "auto_upgrade", skip_serializing_if = "Option::is_none")]
    pub auto_upgrade: Option<bool>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<models::ClusterReadStatus>>,
    ...
    #[serde(rename = "surge_upgrade", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "registry_enabled", skip_serializing_if = "Option::is_none")]
    ...
    pub registries: Option<Option<Vec<String>>>,
    #[serde(
        rename = "control_plane_firewall",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub control_plane_firewall: Option<Option<Box<models::ControlPlaneFirewall>>>,
    #[serde(
        rename = "cluster_autoscaler_configuration",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub cluster_autoscaler_configuration:
        Option<Option<Box<models::ClusterAutoscalerConfiguration>>>,
    #[serde(
        rename = "routing_agent",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub routing_agent: Option<Option<Box<models::RoutingAgent>>>,
    #[serde(
        rename = "amd_gpu_device_plugin",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub amd_gpu_device_plugin: Option<Option<Box<models::AmdGpuDevicePlugin>>>,
    #[serde(
        rename = "amd_gpu_device_metrics_exporter_plugin",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub amd_gpu_device_metrics_exporter_plugin:
        Option<Option<Box<models::AmdGpuDeviceMetricsExporterPlugin>>>,
    #[serde(
        rename = "nvidia_gpu_device_plugin",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub nvidia_gpu_device_plugin: Option<Option<Box<models::NvidiaGpuDevicePlugin>>>,
    #[serde(
        rename = "rdma_shared_dev_plugin",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub rdma_shared_dev_plugin: Option<Option<Box<models::RdmaSharedDevPlugin>>>,
}
...
impl ClusterRead {
    pub fn new(
        ...
        region: String,
        version: String,
        node_pools: Vec<models::KubernetesNodePool>,
    ) -> ClusterRead {
        ClusterRead {
            id: None,
            name,
            ...
            registries: None,
            control_plane_firewall: None,
            cluster_autoscaler_configuration: None,
            routing_agent: None,
            amd_gpu_device_plugin: None,
            amd_gpu_device_metrics_exporter_plugin: None,
            nvidia_gpu_device_plugin: None,
            rdma_shared_dev_plugin: None,
        }
    }
}
