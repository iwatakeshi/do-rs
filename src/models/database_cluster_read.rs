...
pub struct DatabaseClusterRead {
    ...
    #[serde(rename = "semantic_version", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "db_names", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub db_names: Option<Option<Vec<String>>>,
    /// The connection details for OpenSearch dashboard. 
    #[serde(rename = "ui_connection", skip_serializing_if = "Option::is_none")]
    pub ui_connection: Option<Box<models::OpensearchConnection>>,
    /// The connection details for Schema Registry.
    #[serde(rename = "schema_registry_connection", skip_serializing_if = "Option::is_none")]
    pub schema_registry_connection: Option<Box<models::SchemaRegistryConnection>>,
    #[serde(rename = "connection", skip_serializing_if = "Option::is_none")]
    pub connection: Option<Box<models::DatabaseConnection>>,
    #[serde(rename = "private_connection", skip_serializing_if = "Option::is_none")]
    pub private_connection: Option<Box<models::DatabaseConnection>>,
    #[serde(rename = "standby_connection", skip_serializing_if = "Option::is_none")]
    pub standby_connection: Option<Box<models::DatabaseConnection>>,
    #[serde(rename = "standby_private_connection", skip_serializing_if = "Option::is_none")]
    pub standby_private_connection: Option<Box<models::DatabaseConnection>>,
    #[serde(rename = "users", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub users: Option<Option<Vec<models::DatabaseUser>>>,
    #[serde(rename = "maintenance_window", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub maintenance_window: Option<Option<Box<models::DatabaseMaintenanceWindow>>>,
    ...
    #[serde(rename = "version_end_of_life", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "version_end_of_availability", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "storage_size_mib", skip_serializing_if = "Option::is_none")]
    pub storage_size_mib: Option<i32>,
    ...
    #[serde(rename = "metrics_endpoints", skip_serializing_if = "Option::is_none")]
    pub metrics_endpoints: Option<Vec<models::DatabaseServiceEndpoint>>,
}

impl DatabaseClusterRead {
    pub fn new(name: String, engine: Engine, num_nodes: i32, size: String, region: String) -> DatabaseClusterRead {
        DatabaseClusterRead {
            id: None,
            name,
            engine,
            ...
            db_names: None,
            ui_connection: None,
            schema_registry_connection: None,
            connection: None,
            ...
            project_id: None,
            rules: None,
            version_end_of_life: None,
            version_end_of_availability: None,
