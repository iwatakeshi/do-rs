...
impl FloatingIpDroplet {
    ...
    pub fn new(
        ...
        features: Vec<String>,
        backup_ids: Vec<i32>,
        next_backup_window: Option<models::DropletNextBackupWindow>,
        snapshot_ids: Vec<i32>,
        image: models::Image,
        volume_ids: Vec<String>,
        size: models::Size,
        size_slug: String,
        networks: models::DropletNetworks,
        ...
        FloatingIpDroplet {
            ...
            features,
            backup_ids,
            next_backup_window: if let Some(x) = next_backup_window {
                Some(Box::new(x))
            } else {
                None
            },
