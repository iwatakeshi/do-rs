...
pub enum DropletActionsPostRequest {
    #[serde(rename = "change_backup_policy")]
    DropletActionChangeBackupPolicy {
        /// An object specifying the backup policy for the Droplet.
        #[serde(rename = "backup_policy")]
        backup_policy: Box<models::DropletBackupPolicy>,
        #[serde(rename = "image", skip_serializing_if = "Option::is_none")]
        image: Option<Box<models::DropletActionRebuildAllOfImage>>,
...
impl Default for DropletActionsPostRequest {
    fn default() -> Self {
        Self::DropletActionChangeBackupPolicy {
