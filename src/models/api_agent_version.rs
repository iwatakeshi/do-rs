...
pub struct ApiAgentVersion {
    ...
    #[serde(
        rename = "attached_child_agents",
        skip_serializing_if = "Option::is_none"
    )]
    pub attached_child_agents: Option<Vec<models::ApiAgentChildRelationshipVerion>>,
    /// List of function versions
    #[serde(rename = "attached_functions", skip_serializing_if = "Option::is_none")]
    pub attached_functions: Option<Vec<models::ApiAgentFunctionVersion>>,
    /// List of guardrail version
    #[serde(
        rename = "attached_guardrails",
        skip_serializing_if = "Option::is_none"
    )]
    pub attached_guardrails: Option<Vec<models::ApiAgentGuardrailVersion>>,
    /// List of knowledge base agent versions
    #[serde(
        rename = "attached_knowledgebases",
        skip_serializing_if = "Option::is_none"
    )]
    pub attached_knowledgebases: Option<Vec<models::ApiAgentKnowledgeBaseVersion>>,
    /// Whether the version is able to be rolled back to
    #[serde(rename = "can_rollback", skip_serializing_if = "Option::is_none")]
    pub can_rollback: Option<bool>,
    /// Creation date
    #[serde(rename = "created_at", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// User who created this version
    #[serde(rename = "created_by_email", skip_serializing_if = "Option::is_none")]
    pub created_by_email: Option<String>,
    /// Whether this is the currently applied configuration
    #[serde(rename = "currently_applied", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "trigger_action", skip_serializing_if = "Option::is_none")]
...
impl ApiAgentVersion {
    /// Represents an AgentVersion entity
    pub fn new() -> ApiAgentVersion {
        ApiAgentVersion {
            agent_uuid: None,
            attached_child_agents: None,
            attached_functions: None,
            attached_guardrails: None,
            attached_knowledgebases: None,
            can_rollback: None,
            created_at: None,
            created_by_email: None,
            currently_applied: None,
            description: None,
            id: None,
            instruction: None,
            k: None,
