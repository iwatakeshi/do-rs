...
**tags** | Option<**Vec<String>**> | An array of tags (as strings) to apply to the database cluster. <br><br>Requires `tag:create` scope. | [optional]
...
**project_id** | Option<[**uuid::Uuid**](uuid::Uuid.md)> | The ID of the project that the database cluster is assigned to. If excluded when creating a new database cluster, it will be assigned to your default project.<br><br>Requires `project:update` scope. | [optional]
...
**autoscale** | Option<[**models::DatabaseAutoscaleParams**](database_autoscale_params.md)> | Autoscaling configuration for the database cluster. Currently only supports storage autoscaling. If null, autoscaling is not configured for the cluster. | [optional]
**backup_restore** | Option<[**models::DatabaseBackup**](database_backup.md)> |  | [optional]
