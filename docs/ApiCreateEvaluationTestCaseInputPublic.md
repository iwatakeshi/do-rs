...
**name** | Option<**String**> | Name of the test case. | [optional]
**star_metric** | Option<[**models::ApiStarMetric**](apiStarMetric.md)> |  | [optional]
**workspace_uuid** | Option<**String**> | The workspace uuid. | [optional]
