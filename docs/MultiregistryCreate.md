...
**subscription_tier_slug** | Option<**String**> | The slug of the subscription tier to sign up for. Valid values can be retrieved using the options endpoint. | [optional]
