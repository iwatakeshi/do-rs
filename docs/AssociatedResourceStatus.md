...
------------ | ------------- | ------------- | -------------
**droplet** | Option<[**models::DestroyedAssociatedResource**](destroyed_associated_resource.md)> |  | [optional]
**resources** | Option<[**models::AssociatedResourceStatusResources**](associated_resource_status_resources.md)> |  | [optional]
