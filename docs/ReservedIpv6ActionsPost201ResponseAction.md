# ReservedIpv6ActionsPost201ResponseAction
...
**resource_id** | Option<**i32**> | The ID of the resource that the action is being taken on. | [optional]
**resource_type** | Option<**String**> | The type of resource that the action is being taken on. | [optional]
**region** | Option<[**models::Region**](region.md)> |  | [optional]
**region_slug** | Option<**String**> | The slug identifier for the region the resource is located in. | [optional]
